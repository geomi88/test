...
<script>
    ...
    $(document).ready(function ()
    {
     ...
     $('.takePrint').click(function () {
        ...
        if(!$("#titlee").is(':checked')&&!$("#employee").is(':checked')&&!$("#warningTypee").is(':checked')&&!$("#branchNamee").is(':checked')&&!$("#descriptionn").is(':checked')) {
    ...
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Warnings</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            ...
                                            '<td style="padding:10px 0;color:#fff;" class="war_name"> Employee</td>'+
                     ...
                     <div class="printChoose">
                        <div class="custRow">
                            ...
                            <div class="custCol-4">
                                <div class="commonCheckHolder checkRender">
                                    <label>
                                        <input id="warningTypee" checked="" type="checkbox">
                                        <span></span>
                                        <em>Warning Type</em>
                                    </label>
                                </div>
            ...
            <div id="tblcategorytable">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tbody class="categorybody" id='categorybody'>
                        @include('checklist/edit_warning/result')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            ...
            $('#page-limit').val(10);
            //search();
            window.location.href = '{{url("checklist/editwarnings")}}';
        });
    });
