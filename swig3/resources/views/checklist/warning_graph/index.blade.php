...
<div class="infoBarV1 supervisorsalesgraph">
    <form action="{{ url('checklist/getcategorygraph') }}" method="post" id="frmsupervisorgraph">
    <div class="leftSection">
        ...
        <div class="totalCount">
            <ul>
                <li>Total Warnings :<span>{{$totalcount}}</span></li>
...
<script>
    Highcharts.chart('supervisor_wise_sales', {
        ...
        title: {
            text: 'Warnings By Category'
        },
       
        xAxis: {
            categories: <?php echo $arrwarnings;?>,
            title: {
                text: null
            }
        },
