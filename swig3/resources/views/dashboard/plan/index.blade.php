...
$('.takePrint').click(function () {
        ...
        if(!$("#slno").is(':checked')&&!$("#title").is(':checked')&&!$("#startDate").is(':checked')&&!$("#endDate").is(':checked')&&!$("#status").is(':checked')&&!$("#createdDate").is(':checked')&&!$("#description").is(':checked')&&!$("#amount").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#slno").is(':checked')){
                strStyle+=' .plan_slno {display:none;}';
         }
         if(!$("#title").is(':checked')){
             strStyle+=' .plan_title {display:none;}';     
         }
         if(!$("#startDate").is(':checked')){
                strStyle+=' .plan_start {display:none;}';
         }
         if(!$("#endDate").is(':checked')){
               strStyle+=' .plan_end {display:none;}';
         }
         if(!$("#status").is(':checked')){
              strStyle+=' .plan_status {display:none;}';  
         } 
         if(!$("#createdDate").is(':checked')){
              strStyle+=' .plan_date {display:none;}';   
         }
         if(!$("#description").is(':checked')){
               strStyle+=' .plan_description {display:none;}';   
         }
    ...
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Plans</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_slno"> Sl.No.</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_title"> Title</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_start"> Start Date </td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_end"> End Date </td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_status"> Status </td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_date"> Created Date </td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="plan_description"> Description </td>'+
                                        '</tr>'+
...
<div class="innerContent">
    ...
    <?php } ?>
    <form id="pdfgenerator" action="{{ url('dashboard/plan/exportdata') }}" method="post">
        ...
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-12">
                    <a href="{{ action('Tasks\PlanController@createplan') }}" class="right commonBtn commonBtn bgGreen addBtn">Create</a>
                </div>
            </div>
            ...
            <div id="tblregion">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tbody class="planbody" id='planbody'>
                        @include('dashboard/plan/plan_result')
                    </tbody>
...
//        });
    ...
    $('#reset').click(function () {
            window.location.href = '{{url("dashboard/plan")}}';
    });
