...
$('.takePrint').click(function () {
        ...
        if(!$("#slno").is(':checked')&&!$("#title").is(':checked')&&!$("#startDate").is(':checked')&&!$("#endDate").is(':checked')&&!$("#status").is(':checked')&&!$("#createdDate").is(':checked')&&!$("#assignedBy").is(':checked')&&!$("#description").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#assignedBy").is(':checked')){
             strStyle+=' .task_assigned {display:none;}';     
         }
    ...
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Task List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            ...
                                            '<td style="padding:10px 0;color:#fff;" class="task_assigned"> Assigned By </td>'+
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('dashboard/task_list/exportdata') }}" method="post">
                        ...
                        <div class="custRow">
                         ...
                         <div class="custRow">
                             <div class="custCol-4">
                                <div class="commonCheckHolder checkRender">
                                    <label>
                                        <input id="assignedBy" checked="" type="checkbox">
                                        <span></span>
                                        <em>Assigned By</em>
                                    </label>
                                </div>
            ...
            <div id="tblregion">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tbody class="taskbody" id='taskbody'>
                        @include('dashboard/task_list/task_result')
                    </tbody>
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            ...
            $('#page-limit').val(10);
            //search();
            window.location.href = '{{url("dashboard/task_list")}}';
        });
