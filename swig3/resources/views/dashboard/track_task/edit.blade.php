...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Update Assigned <span>Task</span></h1>
    </header>	
    
    <div class="custRow">
        <div class="custCol-6">
            <form action="{{ action('Tasks\TracktaskController@update') }}" method="post" id="frmeditplan">
                    ...
                    <div class="custRow">
                        <div class="custCol-5">
                            <div class="inputHolder bgSelect">
                                <label>Status</label>
                                <select class="commoSelect" name="task_status" id="task_status" disabled="true">
                                    <option value="">Select Status</option>
                                    <option <?php if ($plan->status ==1) { echo "selected";} ?> value="1">New</option>
        ...
        <div class="custCol-6 clshistory">
             <div class="employeesHistory">
                <span>Employ Name: {{$plan->first_name}} {{$plan->alias_name}}</span>
                @foreach ($history as $data)
                <?php $date=date('d-m-Y H:i:s',strtotime($data->created_at));
