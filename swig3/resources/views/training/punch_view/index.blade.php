...
<div class="graphTypeV2 chartRegion">
    <div class="salesFilter">
        <form action="{{ url('training/getmonthwiseperformance') }}" method="post" id="frmperformancegraph">
            <div class="custRow">
                <div class="custCol-3">
                ...
                <div id="tblregion">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="logbody" id='logbody'>
                            @include('training/punch_view/result')
                        </tbody>
...
<script>
    ...
    $(document).ready(function () {
        ...
        chart = new Highcharts.Chart('region_graph', {
            ...
            title: {
                text: 'Employee Training Performance'
            },
            yAxis: {
                title: {
                    text: ''
