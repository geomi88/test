...
<div class="contentArea">
    <a class="btnAction action bgGreen" href="{{ URL::to('mis/supervisor_cash_deposit_report')}}">Back</a>
<div class="innerContent">
     ...
     <h4 style="margin-top: 18px;" class="blockHeadingV1 spacingBtm2 alignRight">Total : <?php echo Customhelper::numberformatter($total_cash); ?></h4>	
