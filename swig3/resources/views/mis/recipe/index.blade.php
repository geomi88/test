...
<div class="innerContent">
    ...
    <div class="headingHolder deskCont">
		...
		<a class="btnAction disable bgOrange" href="{{ URL::to('mis/recipe/docs/'.$status, ['id' => Crypt::encrypt($document->id)]) }}"><?php echo $status; ?></a>
		<a class="btnAction delete bgLightRed" href="{{ URL::to('mis/recipe/docs/delete', ['id' => Crypt::encrypt($document->id)]) }}">Delete</a>
		</div>
		</div>
		</li>
            </ul>           
