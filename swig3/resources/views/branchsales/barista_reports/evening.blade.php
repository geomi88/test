...
<script>
    ...
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Barista In Duty Evening Shift</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('branchsales/barista_evening_shift/exportdata') }}" method="post">
    <header class="pageTitle">
        <h1>Barista In Duty <span>Evening Shift</span></h1>
    </header>
            ...
            <div id="tblcategorytable">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tbody class="reportbody" id='reportbody'>
                        @include('branchsales/barista_reports/evening_result')
                    </tbody>
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            ...
            $('#page-limit').val(10);
            //search();
            window.location.href = '{{url("branchsales/barista_evening_shift")}}';
        });
    });
