...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('branchsales/exportCreditDetails') }}" method="post">
    <header class="pageTitle">
        <h1>Credit Sales <span>Details</span></h1>
    </header>
...
<!--                                    <select class="searchbycategory" name="searchbycategory">
                    ...
                    <tbody class="reportbody" id='reportbody'>
                        @include('branchsales/report_graphs/creditsales_result')
                    </tbody>
