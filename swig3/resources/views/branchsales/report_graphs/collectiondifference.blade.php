...
<script>
    ...
    win.document.write(strStyle+ '<div style="text-align:center;"><h1>Collection Difference Report</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
        ...
        $.ajax(
            {
                ...
                type: "get",
                datatype: "html",
                data: {searchbycode: searchbycode, search_key: search_key, sortordname: sortordname,sortordcode:sortordcode,sortordbranch:sortordbranch,sortorddate:sortorddate,sortordamnt:sortordamnt,pagelimit: pagelimit, searchable: searchable,empid:empid,from_date:from_date,to_date:to_date,region_id:region_id,diff_id:diff_id},
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('branchsales/exportCollectionDifference') }}" method="post">
    <header class="pageTitle">
        <h1>Collection Difference <span>Report</span></h1>
    </header>
    ...
    <div class="listerType1 reportLister"> 
            ...
            <input type="hidden" value="{{$diff_id}}" id="diff_id" name="diff_id">
...
<!--                                    <select class="searchbycategory" name="searchbycategory">
                    ...
                    <tbody class="reportbody" id='reportbody'>
                        @include('branchsales/report_graphs/cashier_tips_result')
                    </tbody>
...
<script>
    ...
    function search()
    {
     ...
     var diff_id=$('#diff_id').val();
        ...
        $.ajax({
            type: 'POST',
            url: 'getCollectionDifferenceDetails',
            data: {searchbycode: searchbycode, search_key: search_key, sortordname: sortordname,sortordcode:sortordcode,sortordbranch:sortordbranch,sortorddate:sortorddate,sortordamnt:sortordamnt,pagelimit: pagelimit, searchable: searchable,empid:empid,from_date:from_date,to_date:to_date,region_id:region_id,diff_id:diff_id},
            beforeSend: function () {
                $(".commonLoaderV1").show();
            },
