...
<div class="infoBarV1 supervisorsalesgraph">
    <form action="{{ url('branchsales/getcashsale') }}" method="post" id="frmsupervisorgraph">
    <div class="leftSection">
        ...
        <div class="totalCount">
            <ul>
                ...
                <li>Total Cash Sales :<span>{{$actualsale}}</span></li>
            </ul>
    ...
    $("#from_date").datepicker({
     ...
     $("#to_date").datepicker({
      ...
      function getSalesDetails(empid, from_date, to_date, region_id) {
        ...
        form.action = "<?php  echo url('branchsales/getCashDetails'); ?>";
        form.method = "post";
        form.target="_blank";
