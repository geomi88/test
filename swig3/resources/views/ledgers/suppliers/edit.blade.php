...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Edit <span>Supplier</span></h1>
    </header>

    <div class="formListV1 clsparentdiv">
        <form action="" method="post" id="supplier_updation" enctype="multipart/form-data">
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                         <div class="inputHolder">
                             ...
                             <input type="text" name="first_name" id="first_name" placeholder="Enter Company Name" maxlength="200" value="{{$supplier_data->first_name}}">
                             <input type="hidden" name="last_name" id="last_name"  autocomplete="off" placeholder="Enter Last Name" maxlength="200" value="">
                             <span class="commonError"></span>
                         </div>
                        </div>
                        <div class="custCol-4">
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <input type="text" name="contact_number" id="contact_number" placeholder="Enter Office Telephone" maxlength="20" value="{{$supplier_data->contact_number}}">
                                <input type="hidden" name="company_name" id="company_name" placeholder="Enter Company Name" maxlength="200" value="">
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                ...
                <div class="stepFields">
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="bank_name" id="bank_name" placeholder="Enter Bank Name" maxlength="200" value="{{$supplier_data->bank_name}}">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>City</label>
                                <input type="text" name="bank_city" id="bank_city"  placeholder="Enter City" maxlength="100" value="{{$supplier_data->bank_city}}">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="cr_number" id="cr_number"  placeholder="Enter CR Number" maxlength="50" value="{{$supplier_data->cr_number}}">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    </div>
            ...
            <form action="" method="post" id="frmProduct" enctype='multipart/form-data'>
                <div class="formRange">
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-8">
                            <button class="commonBtn bgGreen right addNext open3" type="button">Save and Go <span class="fa fa-arrow-right"></span></button> 
                            <div class="customClear"></div>
                        </div>
                    </div>
            </form>
        ...
        <div class="formListV1Dtl" id="step4" style="display: none;">
            ...
            <form action="{{url('suppliers/update_upload_documents')}}" method="post" id="docuform" enctype='multipart/form-data'>
                <div class="formRange">
                    <ul>
                        <li class="selected"><span>1</span></li>
                        <li class="selected"><span>2</span></li>
...
<script>
    ...
    $(function () {
        ...
        var v = jQuery("#supplier_updation").validate({
            rules: {
                ledger_group_id: {
                    required: true,
...
//            }
        ...
        if (arrProductList.length > 0) {
            ...
            for (var i = 0; i < arrProductList.length; i++) {
                strHtml += '<tr><td>' + arrProductList[i].product_code + '</td><td>' + arrProductList[i].product_name + '</td>\n\
                            <td><a href="javascript:removeproduct(' + i + ')" class="btnTaskDelete styleList">Remove</a></td></tr>';
            }
    ...
    function savepreferredproducts() {
     ...
     ///////////////////////////////////
    $('#supplier_updation').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data==-1){
                    window.location.href = '{{url("suppliers/editlist")}}';
                    window.scrollTo(0, 0);
                }
            },
            error: function () {
