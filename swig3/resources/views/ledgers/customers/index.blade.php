...
$(document).ready(function()
{
    ...
    $('.takePrint').click(function () {
        ...
        if(!$("#slNo").is(':checked')&&!$("#customerCode").is(':checked')&&!$("#customerName").is(':checked')&&!$("#countryy").is(':checked')&&!$("#mailid").is(':checked')&&!$("#phno").is(':checked')&&!$("#statuss").is(':checked')) {
...
<div class="innerContent">
 ...
 <form  id="pdfgenerator" action="{{ url('customers/exportdata') }}" method="post">
        ...
        <div class="listerType1 reportLister"> 
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tbody class="customer_list" id='customer_list'>
                   @include('ledgers/customers/searchresults')
                </tbody>
