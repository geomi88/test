        ...
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-12">
                    <a href="{{ action('Organizationchart\PolicyController@add') }}" class="right commonBtn commonBtn bgGreen addBtn">Create</a>
                </div>
            </div>
                ...
                <div id="tblregion">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="policybody" id='policybody'>
                            @include('organizationchart/policy/result')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            window.location.href = '{{url("organizationchart/policy")}}';
        });
