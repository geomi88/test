    ...
    $(document).ready(function ()
    {
        ...
        $('.print').click(function () {
            ...
            win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>' +
                    '<div style="text-align:center;"><h1>'+strRatingName+' Employees</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
...
<div class="graphTypeV2 chartRegion">
    <div class="salesFilter">
        <form action="{{ url('organizationchart/getmonthwiseperformance') }}" method="post" id="frmperformancegraph">
            <div class="custRow">
                <div class="custCol-3">
...
<div id="divbottom">
    <div class="innerContent">
        <form id="pdfgenerator" action="{{ url('organizationchart/punch_view/exportdata') }}" method="post">
                ...
                <div id="tblregion">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="logbody" id='logbody'>
                            @include('organizationchart/punch_view/result')
                        </tbody>
