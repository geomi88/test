...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Add <span>Region</span></h1>
    </header>	

    <form action="{{ action('Masterresources\RegionController@store') }}" method="post" id="regioninsertion">
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">                           
                <div class="custCol-4">
                    <div class="inputHolder regionName">
                        <label>Region Name</label>
                        <input type="text" name="name" id="name" placeholder="Enter Region Name">
            ...
            <div class="custRow">
                <div class="custCol-4">
                    <input type="submit" value="Create" class="commonBtn bgGreen addBtn addregion">
                </div>
            </div>
