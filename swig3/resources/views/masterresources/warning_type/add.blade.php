...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Add <span>Warning Type</span></h1>
    </header>	

    <form action="{{ action('Masterresources\WarningtypeController@store') }}" method="post" id="frmchecklistsave">
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder checklistcatName">
                        <label>Warning Type</label>
                        <input type="text" name="name" id="name"  autocomplete="off" placeholder="Enter Warning Type" maxlength="250">
