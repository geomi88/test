    ...
    $(document).ready(function ()
    {
        ...
        $('.print').click(function () {
            ...
            win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>' +
                    '<div style="text-align:center;"><h1>Policy Master List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Policy Master List</h1>
    </header>
    <div class="fieldGroup" id="fieldSet1">
        <div class="custRow">
            <div class="custCol-12">
                <a href="{{ action('Masterresources\PolicymasterController@add') }}" id="btnNew" class="right commonBtn commonBtn bgGreen addBtn">Create</a>
            </div>
        </div>
            ...
            <div id="tblcategorytable">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tbody class="costbody" id='costbody'>
                        @include('masterresources/policy_master/result')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            ...
            $('#sortordname').val('');
            $('#page-limit').val(10);
            window.location.href = '{{url("masterresources/policy_master")}}';
        });
    });
