...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Edit <span>Job Shift</span></h1>
    </header>	

    <form action="{{ action('Masterresources\JobshiftController@update') }}" method="post" id="shiftupdation">
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder shifName ">
                        <label>Shift Name</label>
                        <input type="text" name="name" id="name" value='{{$jobshift->name}}'  onpaste="return false;" autocomplete="off">
                        <input type="hidden" name="cid" id="cid" value="{{ $jobshift->id }}">
                ...
                <div class="custCol-4">
                    <div class="inputHolder">
                        <label>Alias</label>
                        <input type="text" name="alias_name" value='{{$jobshift->alias_name}}' id="alias_name" >
                        <span class="commonError"></span>
                    </div>
                </div>
            </div>
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder">
                        ...
                        <input type="text" name="tin" value='{{$jobshift->start_time}}' id="tin" class="txt">
                ...
                <div class="custCol-4">
                    <div class="inputHolder">
                        ...
                        <input type="text" name="tout" value='{{$jobshift->end_time}}' id="tout" class="txt" >                       
            ...
            <div class="custRow">
                <div class="custCol-4">
                    <input type="submit" value="Update"  class="commonBtn bgGreen addBtn shift" id="sub">
                </div>
            </div>
