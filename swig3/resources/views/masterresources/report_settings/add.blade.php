...
<div class="innerContent">
        ...
        <div class="fieldGroup" id="fieldSet1">
                ...
                <div class="custCol-4">
                    <div class="inputHolder">
                        ...
                        <select class="" name="report_name" id="report_name" class="report_name">
                            ...
                            <option value="<?php echo str_replace(" ", "_", $arrReport);?>">{{$arrReport}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="custRow">
                ...
                <div class="custCol-3">
                    <div class="inputHolder">
                        <label>Time</label>                        
                        <input type="text" name="sendtime" id="sendtime" class="txt">
                        <span class="commonError"></span>
                    </div>
                </div>
            </div>
    ...
    <div class="custRow">
        <div class="custCol-4">
            <input type="button" value="Save" class="commonBtn bgGreen addBtn" id="btnSaveSettings">
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('#btnSaveSettings').click(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '../report_settings/checksettingsexistornot',
