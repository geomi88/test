...
<div class="contentArea">
    <a class="btnAction action bgGreen" href="{{ URL::to('branchsales/cash_collection/accounts')}}">Back</a>
<div class="innerContent">
        ...
        <h4 class="blockHeadingV1">POS Sales Details</h4>
            ...
            <h4 class="blockHeadingV1 spacingBtm2 alignRight">Total : <?php echo $total_cash ?></h4>	
            </div>
