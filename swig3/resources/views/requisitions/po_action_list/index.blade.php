                                ...
                                '<div style="text-align:center;"><h1>Local Purchase Orders</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            '<td style="padding:10px 0;color:#fff;"> PO Number </td>' +
                                            '<td style="padding:10px 0;color:#fff;"> Action Date </td>' +
                                            '<td style="padding:10px 0;color:#fff;"> Action Name </td>' +
                                            '<td style="padding:10px 0;color:#fff;"> Done By </td>' +
                                        '</tr>'+
                ...
                <div id="postable">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                ...
                                <td class="filterFields" style="min-width: 150px;">
                                    <div class="custRow">
                                        <div class="custCol-12">
                                            <input type="text" id="searchbyponumber" name="searchbyponumber" placeholder="Enter PO Number">
                                        </div>
                                    </div>
                                </td>
                        ...
                        <tbody class="order_list" id='order_list'>                  
                            @include("requisitions/po_action_list/results")
                        </tbody>
...
<script>
    ...
    function search()
    {
        ...
        var fromdata = $('#created_at_from').val();
        ...
        $.ajax({
            type: 'POST',
            url: 'po_action_list',
            data: { searchbyponumber:searchbyponumber,fromdata:fromdata,todate: todate,pagelimit:pagelimit},
            beforeSend: function () {
                $(".commonLoaderV1").show();
            },
