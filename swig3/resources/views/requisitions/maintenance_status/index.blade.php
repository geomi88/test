...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        $('.takePrint').click(function () {
            ...
            if (!$("#reqCode").is(':checked') && !$("#title1").is(':checked') && !$("#qOneT").is(':checked') && !$("#resourcetype").is(':checked') && !$("#mainstatus").is(':checked')) {
                ...
                win.document.write(strStyle + '<div style="text-align:center;"><h1>Maintenance Work Status</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
                        ...
                        '<td style="padding:10px 0;color:#fff;" class="statusC"> Status</td>' +
        ...
        $.ajax(
                {
                    ...
                    type: "get",
                    datatype: "html",
                    data: {pagelimit: pagelimit,resource:resource,searchbycenter:searchbycenter,status:status, searchbycode:searchbycode, searchbyname:searchbyname, created_at_from:created_at_from, created_at_to:created_at_to, sortordcode:sortordcode, sortordtitle:sortordtitle, sortorddate:sortorddate},
                    // {
    ...
    <div class="innerContent">
        ...
        <header class="pageTitle" style="margin-bottom: 30px;padding-bottom: 10px;">
            <h1> Maintenance Work <span>Status</span></h1>
        </header>

        <form id="pdfgenerator" action="{{ url('requisition/maintenance_status/exportdata') }}" method="post">
                ...
                <div class="custRow">
                    ...
                    <div class="custCol-4">
                     ...
                     <div class="custCol-4">
                        <div class="commonCheckHolder checkRender">
                            <label>
                                <input id="mainstatus" checked="" type="checkbox">
                                <span></span>
                                <em>Status</em>
                            </label>
                        </div>
                ...
                <div class="listerType1 cash_collections"> 
                    <table style="width: 100%;" cellspacing="0" cellpadding="0">
                        ...
                        <tbody class="minsalesplan" id='minsalesplan'>
                            @include('requisitions/maintenance_status/results')
                        </tbody>
                    </table>
...
<script>
    ...
    function search()
    {
        ...
        $.ajax({
            type: 'POST',
            url: 'maintenance_status',
            data: {searchbycode: searchbycode,resource:resource,searchbycenter:searchbycenter,status:status, pagelimit: pagelimit, searchbyname:searchbyname, created_at_from:created_at_from, created_at_to:created_at_to, sortordcode:sortordcode, sortordtitle:sortordtitle, sortorddate:sortorddate},
            beforeSend: function () {
                $(".commonLoaderV1").show();
            },
    ...
    $("#reset").click(function () {
        window.location.href = '{{url("requisition/maintenance_status")}}';
    });
