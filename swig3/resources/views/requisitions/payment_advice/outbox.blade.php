        ...
        $('.print').click(function () {
            var pageTitle = 'Page Title',
                ...
                win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>'+
                                '<div style="text-align:center;"><h1>Payment Advices List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('requisitions/exportdata_paymentadvicelist') }}" method="post">
        <header class="pageTitle">
            <h1>Payment Advices <span> List</span></h1>
        </header>	
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <thead class="listHeaderBottom">
                            ...
                            <tr class="headingHolder">
                                ...
                                <td class="filterFields" style="min-width: 100px;"></td>
                                <td></td>
                            </tr>
                        ...
                        <tbody class="outbox_list" id='outbox_list'>                  
                            @include('requisitions/payment_advice/outbox_results')
                        </tbody>
...
<script>
    ...
    function search()
    {
        ...
        $.ajax({
            type: 'POST',
            url: 'outbox',
            data: { searchbycode:searchbycode,searchbyname: searchbyname,created_at_from:created_at_from,created_at_to:created_at_to,sortordcode:sortordcode,sortorddate:sortorddate, pagelimit: pagelimit},
            beforeSend: function () {
                $(".commonLoaderV1").show();
            },
