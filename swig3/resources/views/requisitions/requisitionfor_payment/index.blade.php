        ...
        $('.print').click(function () {
            var pageTitle = 'Page Title',
                ...
                win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>'+
                                '<div style="text-align:center;"><h1>Approved Requisitions For Payment</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        ...
                                        '</tr>'+
                                    '</thead>'+ $('.pa_list')[0].outerHTML +'</table>');
            win.document.close();
            win.print();
            win.close();
            return false;
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('requisitions/payment_advice/exportdata') }}" method="post">
        <header class="pageTitle">
            <h1>Approved Requisitions For <span>Payment</span></h1>
        </header>	
            ...
            <div class="listerType1 reportLister"> 
                ...
                <div id="postable">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="pa_list" id='pa_list'>                  
                            @include('requisitions/requisitionfor_payment/results')
                        </tbody>
