        ...
        $('.print').click(function () {
            var pageTitle = 'Page Title',
                ...
                win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>'+
                                '<div style="text-align:center;"><h1>Owner Drawings Requsitions</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('requisitions/drawing_requsition/exportdatainbox') }}" method="post">
        <header class="pageTitle">
            <h1>Owner Drawings <span>Requisitions</span></h1>
        </header>	
...
<!--                                <td class="filterFields">
                        ...
                        <tbody class="inbox_list" id='inbox_list'>                  
                            @include('requisitions/drawing_requisition/result')
                        </tbody>
