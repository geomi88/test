                                ...
                                '<div style="text-align:center;"><h1>RFQ List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            ...
                                            '<td style="padding:10px 0;color:#fff;"> Supplier Cose </td>' +
        ...
        $.ajax(
                {
                    ...
                    type: "get",
                    datatype: "html",
                    data: { searchbyordcode:searchbyordcode,searchbytitle: searchbytitle,searchbysupcode:searchbysupcode,searchbysupname:searchbysupname,created_at_from:created_at_from,created_at_to:created_at_to,sortordpocode:sortordpocode,sortorddate:sortorddate, pagelimit: pagelimit},
                    // {
                ...
                <div id="postable">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        <thead class="listHeaderTop">
                            <tr class="headingHolder">
                                ...
                                <td>
                                    Supplier Name
                                    <div class="sort">
                                        <a href="javascript:void(0)" class="btnUp supup"></a>
                                        <a href="javascript:void(0)" class="btnDown supdown"></a>
                                    </div>
                                </td>
                        ...
                        <thead class="listHeaderBottom">
                            ...
                            <tr class="headingHolder">
                                ...
                                <td class="filterFields" style="min-width: 150px;">
                                    <div class="custRow">
                                        <div class="custCol-12">
                                            <input type="text" id="searchbysupname" name="searchbysupname" placeholder="Enter Name">
                                        </div>
                                    </div>
                                </td>
                        ...
                        <tbody class="order_list" id='order_list'>                  
                            @include('requisitions/rfq/editresults')
                        </tbody>
