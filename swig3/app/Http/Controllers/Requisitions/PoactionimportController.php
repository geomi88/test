...
class PoactionimportController extends Controller {
    ...
    public function index(Request $request) {
        try {
            ...
            if ($request->ajax()) {
                ...
                return view('requisitions/po_action_import/results', array('purchaseorders' => $purchaseorders));
            }
            return view('requisitions/po_action_import/index', array('purchaseorders' => $purchaseorders));
        } catch (\Exception $e) {
            Toastr::error('Sorry There Was Some Problem!', $title = null, $options = []);
            return Redirect::to('requisitions/po_action_import');
        }
    }
    ...
    public function view($id) {
        try {
            ...
            return view('requisitions/po_action_import/view', array('orderdata' => $orderdata, 'requisitionitems' => $requisitionitems, 'action_takers' => $action_takers));
        } catch (\Exception $e) {
            Toastr::error('Sorry There Was Some Problem!', $title = null, $options = []);
            return Redirect::to('requisitions/po_action_import');
        }
    ...
    public function exportdata() {
        ...
        if ($excelorpdf == "Excel") {
            ...
            Excel::create('Import PO Action', function($excel) use($purchaseorders) {
                // Set the title
                $excel->setTitle('Import PO Action');

                $excel->sheet('Import PO Action', function($sheet) use($purchaseorders) {
                    // Sheet manipulation

                    $sheet->setCellValue('C3', 'Import PO Action');
