...
class ChartController extends Controller
{
     public function index() {
                            ...
                            ->where('documents.document_type', '=', 'CHART')
                            ->where('documents.document_owner_type', '=', 'CHART')
                            ->where('documents.status', '!=', 2)                            
                            ->paginate($paginate);
                             return view('mis/chart/index',array('companies' => $companies,'documents' => $documents));
   }
