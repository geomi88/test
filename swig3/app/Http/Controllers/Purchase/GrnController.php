...
class GrnController extends Controller {
    ...
    public function index(Request $request) {
        try {
            ...
            if ($request->ajax()) {
                ...
                return view('purchase/grn/results', array('purchaseorders' => $purchaseorders));
            }
            return view('purchase/grn/index', array('purchaseorders' => $purchaseorders));
        } catch (\Exception $e) {
            Toastr::error('Sorry There Was Some Problem!', $title = null, $options = []);
            return Redirect::to('purchase/grn');
        }
    }
    ...
    public function updatestock() {
        try {
            ...
            if($orderstatus->po_close_status==1){
                ...
                return \Response::json(array('redirecturl'=>url('purchase/grn')));
            } 
            ...
            $strurl=url('purchase/grn/view').'/'.\Crypt::encrypt($stockData->po_id);
    ...
    public function view($id) {
        try {
            ...
            return view('purchase/grn/view', array('orderdata' => $orderdata, 'orderitems' => $orderitems,
