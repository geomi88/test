...
(function($) {
    $.fn.keyboard = function(options) {
        ...
        var settings = $.extend({
            ...
            btnActiveClasses: 'active redColor',
            initCaps: false,
            placement: 'bottom',
            container:'body',
            trigger: 'focus'
                ...
                content: function() {
                    ...
                    $.each(settings.layout, function() {
                        ...
                        $.each(line, function() {
                            ...
                            switch (this[0]) {
                                case 'shift':
                                    btn.addClass('jqbtk-shift').html('<span class="glyphicon glyphicon-arrow-up" style="color:#000;"></span>');
                                    break;
                                case 'space':
                                    btn.addClass('jqbtk-space').html('&nbsp;');
                                    break;
                                case 'del':
                                    btn.addClass('jqbtk-del').html('<span class="glyphicon glyphicon-arrow-left" style="color:#000;"></span>');
                                    break;
                                case 'enter':
