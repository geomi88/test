...
<div class="contentHolderV1">
    ...
    <div class="notificationSelect">
        <div class="leftSide">
            ...
            <?php echo $__env->make('users/user_result', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    ...
    <form method="post" action="<?php echo e(action('Users\UsersController@sendnotification')); ?>" id="sendNotificationform" enctype="multipart/form-data" class="formTypeV1">
