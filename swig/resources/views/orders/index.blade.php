...
<div class="contentHolderV1">
    ...
    <div class="searchWrapper">
        <form class="searchArea" id="productSearch" action="{{ action('Orders\OrdersController@search') }}" method="post">
            {{ csrf_field() }}
            <input type="text" id="search_key" placeholder="Search by Order Number,Buyer Name or Seller Name" name="search_key" >
            <input type="hidden" id="deal_key" name="deal_key">
    ...
    <table style="width: 100%;" class="tableV1" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <?php $n = $orders->perPage() * ($orders->currentPage() - 1); ?>
                <?php
