...
class OwnerController extends Controller {
   ...
   public function view_property($p_id) {
        ...
        $render_params['gallery']=$gallery;
            ...
            return view('owner.property.property-detail-view', $render_params);
    ...
    public function add_property() {
        ...
        return view('owner.property.add-property',array('pageData'=>$pageData));
    ...
    public function save_property(Request $request) {
        try{
           $input=Input::all();
            ...
            if ($request->hasFile('property_plan')) {
                ...
                $objmodel->agent_id= Session::get('ownerId');
            ...
            return Redirect::to('owner/add-property');
      ...
      public function edit_property($p_id) {
        try {
            ...
            return view('owner.property.edit-property', array('pageData'=>$pageData));
...
public function remove_gallery(Request $request){
 ...
 public function get_list_property(Request $request){
        ...
        $municipality=Property::select('municipalities.id as id','municipalities.name as name')
                    ->leftjoin('municipalities', 'municipalities.id', '=', 'properties.municipality_id')
                    ->where('properties.agent_id', '=', $ownerId)
        ...
        if($request->ajax()) { 
            ...
            return view('owner.property.property-list-result', array('property_list'=>$property_list));
        }   
         ...
         $dataArray=array(
            ...
            return view('owner.property.property-listing',$dataArray );
}
    ...
    public function edit_profile($id){
      try {
           $pageData=array();
            ...
            return view('owner.login.edit-profile',$pageData );
    ...
    public function update_account(Request $request){
     try {
            ...
            session(['ownerLogin' => false]); session(['ownerUser' => $agent_data]);
