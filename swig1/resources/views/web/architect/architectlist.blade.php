                ...
                <section class="contentWrapper neigh">
                    <div class="pageCenter">
                        <ul class="breadcrumbsHolder">
                            ...
                            <li>
                                <a href="javascript:void();">{{__('architects')}}</a>
                            </li>
                        </ul>
                        ...
                        <div class="row small-up-1 medium-up-3 large-up-3">
                            @foreach($architect_list as $architects)
                             <?php
                                    $image = 'default_image/property_default.png';

                                    if ($architects->images == "" || $architects->images == NULL) {
                                        ?>

                                        <?php
                                    } else {
                                        $image = url('/') . '/uploads/architect-gallery/' . $architects->images;
                            ...
                            <div class="column constructionList">
                                <figure>
                                    <a href="{{ URL::to('web/architect/architect-view', ['id' => Crypt::encrypt($architects->id)]) }}">
                                
                                    <img src="{{URL::asset($image)}}" alt="">
                                <div class="mask">
                                    <div class="textContent center">
                                     <span>{{$architects->name}}</span>
                                    </div>
                                </div>
                                    </a>
                                </figure>
