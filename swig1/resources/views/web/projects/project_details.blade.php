...
@section('content')
        <section class="layoutWrapper">
             <div class="mobileNav">
                 <ul>
                     <li  class="active"><a href="{{URL::to('project/construction-view',['url'=>$constructionDetails->url])}}">{{__('project')}}</a></li>
                          ...
                          <div class="contenFirstRow">
                            <div class="row pageContent pageText">
                              <div class="small-12 medium-12 large-12 column">
                                <h1>{{$constructionDetails->name}}</h1>
                                 <p class="">
                                <?php echo htmlspecialchars_decode($constructionDetails->description);?>
                                 </p>
<!--                               <h2 class="title">The Stockholm Residence - Perfect Facts</h2>-->
                              </div>
                            </div>
