        ...
        <section class="layoutWrapper">
             <div class="mobileNav">
                <ul>
                    ...
                    <li class="active"><a href="{{URL::to('project/construction-perfect-comfort',['url'=>$constructionDetails->url])}}">{{__('perfect-comfort')}}</a></li>
                        ...
                        <div class="top-bar" id="desktop-menu" role="navigation" >
                            <div>
                                <ul>
                                    ...
                                    <li><a href="{{URL::to('project/construction-surrouding',['url'=>$constructionDetails->url])}}">{{__('surrounding')}}</a></li>
                                    <li><a href="{{URL::to('project/construction-garden',['url'=>$constructionDetails->url])}}">{{__('garden')}}</a></li>
                                    <li class="active"><a href="{{URL::to('project/construction-perfect-comfort',['url'=>$constructionDetails->url])}}">{{__('perfect_comfort')}}</a></li>
                                    <li><a href="{{URL::to('project/construction-contact',['url'=>$constructionDetails->url])}}">{{__('interest')}}</a></li>
 ...
 <div class="galleryOverlay">
        ...
        <div class="galleryContainer">
                <div id="slideshow" class="fullscreen">
                        ...
                        <div id="img-{{$galImages->id}}" data-img-id="{{$galImages->id}}" class="img-wrapper"  style="background-image: url({{ URL::asset('uploads/project-gallery')}}/{{$galImages->image}});"></div>
                        @endforeach
                    ...
                    <div class="thumbs-container bottom">
                        ...
                        <ul class="thumbs">
                            @foreach($galleryImages as $galImages)
                            <li data-thumb-id="{{$galImages->id}}" class="thumb" style="background-image: url({{ URL::asset('uploads/project-gallery')}}/{{$galImages->image}});"></li>
                            @endforeach
