        ...
        <section class="layoutWrapper">
             <div class="mobileNav">
                <ul>
                    ...
                    <li  class="active"><a href="{{URL::to('project/construction-surrouding',['url'=>$constructionDetails->url])}}">{{__('surrounding')}}</a></li>
                             ...
                             <h2>{{__('photo_gallery')}}</h2>
                              <section class="gallery slider galleryImageSlider">
                                    ...
                                    if ($gallery->image == "" || $gallery->image == NULL) {
                                        ...
                                        $image =url('/'). '/uploads/project-surrounding/' . $gallery->image;
 ...
 <div class="galleryOverlay">
        ...
        <div class="galleryContainer">
                <div id="slideshow" class="fullscreen">
                        ...
                        <div id="img-{{$galImages->id}}" data-img-id="{{$galImages->id}}" class="img-wrapper"  style="background-image: url({{ URL::asset('uploads/project-surrounding')}}/{{$galImages->image}});"></div>
                        @endforeach
                    ...
                    <div class="thumbs-container bottom">
                        ...
                        <ul class="thumbs">
                            @foreach($galleryImages as $galImages)
                            <li data-thumb-id="{{$galImages->id}}" class="thumb" style="background-image: url({{ URL::asset('uploads/project-surrounding')}}/{{$galImages->image}});"></li>
                            @endforeach
...
<script>
 ...
 $(document).ready(function () {
    ...
    var Lat = '<?php echo $constructionDetails->latitude ;?> ';
    var Lng = '<?php echo $constructionDetails->longitude ;?>';
if(Lat==""){
  var Lat = "41.716667";  
}
if(Lng==""){
