                    ...
                    <div class="row">
                            ...
                            <div class="previewImageHolder">
                                ...
                                <?php
                                            ...
                                            if($previewImg!="") {          
                                                        ...
                                                        if ($previewImg->image == "" || $previewImg->image == NULL) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        } else {
                                                            $filename = url('/') . "/uploads/project-gallery/" . $previewImg->image;
                                ...
                                <img id="previewbox_previewimg" src="{{URL::asset($filename)}}">
                            </div>
                        ...
                        <div class="col-9 mb-3 appendSliderElement">
                             ...
                             <div class="uploadGalleryPrevHolder  mb-2">
                                                        ...
                                                        <?php $i = 0; ?>
                                                        @foreach($slidergallery as $sliders)
                                                        <?php
                                                        $val = '';
                                                        $filename = '';
                                                        if ($sliders->image == "" || $sliders->image == NULL) {
                                                            ...
                                                            $filename = url('/') . "/uploads/project-slider/" . $sliders->image;
                                                            $val = $sliders->image;
                                                        }
                                                        if (!@getimagesize($filename)) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        ...
                                                        <div class="previewImageHolder">
                                                            <span class="delImageSelect previewGalImg" onclick="removeSliderImg({{$sliders->id}})">X</span>
                                                            <img src="{{$filename}}">
                                                        </div>
                                                        <?php $i++; ?>
                                                        @endforeach
                        ...
                        <div class="col-9 mb-3 appendGalleryElement">
                                  <div class="uploadGalleryPrevHolder  mb-2">
                                                        ...
                                                        if ($gallery->image == "" || $gallery->image == NULL) {
                                                            ...
                                                            $filename = url('/') . "/uploads/project-gallery/" . $gallery->image;
                                                            $val = $gallery->image;
                                                        }
                                                        if (!@getimagesize($filename)) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        ...
                                                        <div class="previewImageHolder">
                                                            <span class="delImageSelect previewGalImg" onclick="removeGalleryImg({{$gallery->id}})">X</span>
                                                            <img src="{{$filename}}">
                                                        </div>
                                                        <?php $i++; ?>
                                                        @endforeach
                        ...
                        <div class="col-9 mb-3 appendSurroundingElement">
                             ...
                             <div class="uploadGalleryPrevHolder  mb-2">
                                                        ...
                                                        <?php $i = 0; ?>
                                                        @foreach($surroundImg as $surroundings)
                                                        <?php
                                                        $val = '';
                                                        $filename = '';
                                                        if ($surroundings->image == "" || $surroundings->image == NULL) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        } else {
                                                            $filename = url('/') . "/uploads/project-surrounding/" . $surroundings->image;
                                                            $val = $surroundings->image;
                                                        }
                                                        if (!@getimagesize($filename)) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        }
                                                        ...
                                                        <div class="previewImageHolder">
                                                            <span class="delImageSelect previewGalImg" onclick="removeSurroundImg({{$surroundings->id}})">X</span>
                                                            <img src="{{$filename}}">
                                                        </div>
                                                        <?php $i++; ?>
                                                        @endforeach
                        ...
                        <div class="col-9 mb-3 appendGardenElement">
                            ...
                            <div class="uploadGalleryPrevHolder  mb-2">
                                                        ...
                                                        <?php $i = 0; ?>
                                                        @foreach($gardenImg as $garden)
                                                        <?php
                                                        $val = '';
                                                        $filename = '';
                                                        if ($garden->image == "" || $garden->image == NULL) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        } else {
                                                            $filename = url('/') . "/uploads/project-garden/" . $garden->image;
                                                            $val = $garden->image;
                                                        }
                                                        if (!@getimagesize($filename)) {
                                                            $filename = url('/') . '/default_image/imgPlaceholder.jpg';
                                                        ...
                                                        <div class="previewImageHolder">
                                                            <span class="delImageSelect previewGalImg" onclick="removeGardenImg({{$garden->id}})">X</span>
                                                            <img src="{{$filename}}">
                                                        </div>
                                                        <?php $i++; ?>
                                                        @endforeach
...
$('#btnSaveGallery').click(function(){
 ...
 $('body').on('click', '.previewGalImg', function () {
    ...
    function removeSliderImg(id){
        $.ajax({
          url: '<?php echo url('/')?>/admin/slider-remove',
              data: {"imgId": id},
          type: 'POST',
          async: true,
          dataType: "json",
    ...
    function removeGalleryImg(id){
        $.ajax({
          url: '<?php echo url('/')?>/admin/gallery-remove',
              data: {"imgId": id},
          type: 'POST',
          async: true,
          dataType: "json",
    ...
    function removeSurroundImg(id){
        $.ajax({
          url: '<?php echo url('/')?>/admin/surround-remove',
              data: {"imgId": id},
          type: 'POST',
          async: true,
          dataType: "json",
    ...
    function removeGardenImg(id){
        $.ajax({
          url: '<?php echo url('/')?>/admin/garden-remove',
              data: {"imgId": id},
          type: 'POST',
          async: true,
          dataType: "json",
