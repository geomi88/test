        ...
        margin-bottom: 20px;
			...
			<div class="adminPageHolder adminAddPropertyHolder">
				<div class="text-capitalize adminTitle">
					<h1>Edit Construction</h1>
				</div>
                            <form method="POST" action="<?php echo url('/'); ?>/admin/update-construction" enctype="multipart/form-data" id="addConstruction" >
                                {{ csrf_field() }}
					...
					<div class="tabWrapper tabOuterHolder">
						<ul class="tabLinkStyle tabEventHolder text-uppercase list-unstyled list-inline">
							...
							<li data-tab="ru" class="list-inline-item"><a href="javascript:void(0)">ru</a></li>
                                            ...
                                            <input autocomplete="off" type="hidden" name="projectId" id="projectId" value="{{\Crypt::encrypt($project->id)}}">
						...
						<div id="en" class="tabContent">
							<div class="row">
								...
								<div class="col-9 mb-3 relative">
									<input class="inputStyle" type="text" placeholder="Enter Name" name="name_en" id="name_en" value="{{$project->name_en}}">
								...
								<div class="col-9">
									<textarea rows="4" name="description_en" id="description_en" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->description_en}}</textarea>
								...
								<div class="col-9">
									<textarea rows="4" name="surrounding_description_en" id="surrounding_description_en"  class="inputStyle ckeditor" placeholder="Enter Description">{{$project->surrounding_description_en}}</textarea>
								...
								<div class="col-12 mt-4">
                                        ...
                                        <div class="col-6 clearfix addressManualHolder">
                                            ...
                                            <div class="halfWidth mb-3 relative">
                                                <input class="inputStyle" type="text" name="address_line1_en" id="address_line1_en" placeholder="Address line 1" value="{{$project->address_line1_en}}">
                                            </div>
                                            <div class="halfWidth mb-3 pl-3">
                                                <label class="labelStyle">Address line 2</label>
                                            </div>
                                            <div class="halfWidth mb-3 relative">
                                                <input class="inputStyle" type="text" name="address_line2_en" id="address_line2_en" placeholder="Address line 2" value="{{$project->address_line2_en}}">
                                            </div>
                                            <div class="halfWidth mb-3 pl-3">
                                                <label class="labelStyle">Zip Code</label>
                                            </div>
                                            <div class="halfWidth mb-3 relative">
                                                <input class="inputStyle" type="text" id="zip_en" name="zip_en" placeholder="zip" value="{{$project->zip_en}}">
                                            </div>
                                            <div class="halfWidth mb-3 pl-3">
                                            ...
                                            <div class="halfWidth mb-3 relative munc">
                                                <select name="municipality_en"  id="municipality_en" class="inputStyle chosen-search"> 
                                                    ...
                                                    <option value="{{$cities->id}}" <?php if($cities->id== $project->municipality_id){ echo 'selected'; } ?> >{{$cities->name}}</option>
                                                    @endforeach
                                                </select>
                <!--										<input class="inputStyle" type="text" name="city_en" id="city_en"  placeholder="city">-->
                                            ...
                                            <div class="halfWidth mb-3 relative dist">
                                                <select name="district_en"  id="district_en" class="inputStyle chosen-search"> 
                                                    ...
                                                    <option value="{{$district->id}}" <?php if($district->id== $project->district_id){ echo 'selected'; } ?>>{{$district->name}}</option>
                                                    @endforeach
                                                </select>
                <!--										<input class="inputStyle" type="text" name="city_en" id="city_en"  placeholder="city">-->
                                            </div>
								...
								<div class="col-9 mt-3">
									<textarea  rows="4" name="garden_description_en" id="garden_description_en"  class="inputStyle ckeditor" placeholder="Enter Description">{{$project->garden_description_en}}</textarea>
								</div>
								<div class="col-3 mt-3">
									<label class="labelStyle text-capitalize">perfect comfort</label>
								</div>
								<div class="col-9 mt-3">
									<textarea rows="4" name="comfort_description_en" id="comfort_description_en"  class="inputStyle ckeditor" placeholder="Enter Description">{{$project->comfort_description_en}}</textarea>
								</div>
							</div>
						...
						<div id="ka" class="tabContent">
							<div class="row">
								...
								<div class="col-9 mb-3"> 
									<input class="inputStyle" type="text" placeholder="Enter Name" name="name_ka" id="name_ka" value="{{$project->name_ka}}">
								</div>
								...
								<div class="col-9">
									<textarea rows="4" name="description_ka" id="description_ka" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->description_ka}}</textarea>
								</div>
								...
								<div class="col-9">
									<textarea rows="4" name="surrounding_description_ka" id="surrounding_description_ka"  class="inputStyle ckeditor" placeholder="Enter Description">{{$project->surrounding_description_ka}}</textarea>
								</div>
                                                             <div class="row">
                                        ...
                                        <div class="col-6 clearfix addressManualHolder">
                                            ...
                                            <div class="halfWidth mb-3 relative">
                                                <input class="inputStyle" type="text" name="address_line1_en" id="address_line1_en" placeholder="Address line 1" value="{{$project->address_line1_ka}}">
                                            </div>
                                            <div class="halfWidth mb-3 pl-3">
                                                <label class="labelStyle">Address line 2</label>
                                            </div>
                                            <div class="halfWidth mb-3 relative">
                                                <input class="inputStyle" type="text" name="address_line2_en" id="address_line2_en" placeholder="Address line 2" value="{{$project->address_line2_ka}}">
                                            </div>
                                            <div class="halfWidth mb-3 pl-3">
                                                <label class="labelStyle">Zip Code</label>
                                            </div>
                                            <div class="halfWidth mb-3 relative">
                                                <input class="inputStyle" type="text" id="zip_en" name="zip_en" placeholder="zip" value="{{$project->zip_ka}}">
                                            </div>
                                            <div class="halfWidth mb-3 pl-3">
                                                <label class="labelStyle">City</label>
                                            </div>
                ...
                <!--										<input class="inputStyle" type="text" name="city_en" id="city_en"  placeholder="city">-->
								...
								<div class="col-9 mt-3">
									<textarea rows="4" name="garden_description_ka" id="garden_description_ka" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->garden_description_ka}}</textarea>
								</div>
								<div class="col-3 mt-3">
									<label class="labelStyle text-capitalize">perfect comfort</label>
								</div>
								<div class="col-9 mt-3">
									<textarea rows="4" name="comfort_description_ka" id="comfort_description_ka" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->comfort_description_ka}}</textarea>
								</div>
							</div>
						...
						<div id="ru" class="tabContent">
							<div class="row">
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Enter Name" name="name_ru" id="name_ru" value="{{$project->name_ru}}">
								</div>
								...
								<div class="col-9">
									<textarea rows="4" name="description_ru" id="description_ru"  class="inputStyle ckeditor" placeholder="Enter Description">{{$project->description_ru}}</textarea>
								</div>
								...
								<div class="col-9">
									<textarea rows="4" name="surrounding_description_ru" id="surrounding_description_ru" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->surrounding_description_ru}}</textarea>
								</div>
                ...
                <!--										<input class="inputStyle" type="text" name="city_en" id="city_en"  placeholder="city">-->
								...
								<div class="col-9 mt-3">
									<textarea rows="4" name="garden_description_ru" id="garden_description_ru" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->garden_description_ru}}</textarea>
								</div>
								<div class="col-3 mt-3">
									<label class="labelStyle text-capitalize">perfect comfort</label>
								</div>
								<div class="col-9 mt-3">
									<textarea rows="4" name="comfort_description_ru" id="comfort_description_ru" class="inputStyle ckeditor" placeholder="Enter Description">{{$project->comfort_description_ru}}</textarea>
								</div>
							</div>
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Enter Url" name="url" id="url" value="{{$project->url}}">
									<span class="fieldInfo">.luxestate.com</span>
                                                            ...
                                                            <div class="col-9 mb-3 mt-2">
                                                                 <input class="inputStyle" type="text" name="price" id="price" placeholder="Estimated Price" value='{{$project->price}}'>
								...
								<div class="col-9 mb-3 mt-2">
									<div class="radioCheckStyleHolder float-left text-capitalize">
										  <input id="planning_permits1" name="planning_permits" type="radio" value="1" <?php if($project->planning_permit == '1'){ echo 'checked'; } ?> >
                                                                                  <label for="planning_permits1"><span>yes</span></label>
									</div>
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="planning_permits2" name="planning_permits" type="radio" value="0" <?php if($project->planning_permit == '0'){ echo 'checked'; } ?>>
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" name="destination" id="destination" type="text" placeholder="Residential Area" value="{{$project->destination}}">
								</div>
								<div class="col-3 mb-3">
								...
								<div class="col-9 mb-3 mt-2">
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="subpoenas1" name="subpoenas" type="radio" value="1" <?php if($project->subpoenas == '1'){ echo 'checked'; } ?>>
                                                                                <label for="subpoenas1"><span>yes</span></label>
									</div>
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="subpoenas2" name="subpoenas" type="radio" value="0" <?php if($project->subpoenas == '0'){ echo 'checked'; } ?>>
								...
								<div class="col-9 mb-3 mt-2">
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="judicial_sayings1" name="judicial_sayings" type="radio" value="1"  <?php if($project->subpoenas == '1'){ echo 'checked'; } ?>>
                                                                                <label for="judicial_sayings1"><span>yes</span></label>
									</div>
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="judicial_sayings2" name="judicial_sayings" type="radio" value="0"  <?php if($project->subpoenas == '0'){ echo 'checked'; } ?>>
								...
								<div class="col-9 mb-3 mt-2">
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="pre_emption_right1" name="pre_emption_right" type="radio" value="1"  <?php if($project->pre_emption_right == '1'){ echo 'checked'; } ?>>
                                                                                <label for="pre_emption_right1"><span>yes</span></label>
									</div>
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="pre_emption_right2" name="pre_emption_right" type="radio" value="0"  <?php if($project->pre_emption_right == '0'){ echo 'checked'; } ?>>
								...
								<div class="col-9 mb-3 mt-2">
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="subdivision_permit1" name="subdivision_permit" type="radio" value="1"  <?php if($project->subdivision_permit == '1'){ echo 'checked'; } ?>>
                                                                                <label for="subdivision_permit1"><span>yes</span></label>
									</div>
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="subdivision_permit2" name="subdivision_permit" type="radio" value="0"  <?php if($project->subdivision_permit == '0'){ echo 'checked'; } ?>>
								...
								<div class="col-9 mb-3 mt-2">
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="flood_area1" name="flood_area" type="radio" value="1"  <?php if($project->flood_area == '1'){ echo 'checked'; } ?>>
                                                                                <label for="flood_area1"><span>yes</span></label>
									</div>
									<div class="radioCheckStyleHolder float-left text-capitalize">
										<input id="flood_area2" name="flood_area" type="radio" value="0"  <?php if($project->flood_area == '0'){ echo 'checked'; } ?>>
                                                                                <label for="flood_area2"><span>no</span></label>
									</div>
								</div>
                                                                <div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">upload New floor plan</label>
								</div>
								<div class="col-9 mb-3">
...
<script>
    ...
    $(document).ready(function () {
         geolocator();
         $('#surrounding_desc').ckeditor();
         $('#construction_desc').ckeditor();
        ...
        function (results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                if (results[0]) {
                    ...
                    var div = document.createElement('div');
                    /*$('.munc').html("");
                    $('.munc').html("<input class='inputStyle' type='text' id='municipality_name' name='municipality_name' placeholder='Municipality'>" );
                    $('.dist').html("");
                    $('.dist').html("<input class='inputStyle' type='text' id='district_name' name='district_name' placeholder='District'>");
                     */
                   if (add[0] != null) {
                    ...
                    /*if (add[muncKey] != null) {
                        document.getElementById('municipality_name').value = add[muncKey].long_name;
                    }
                    else {
                        document.getElementById('municipality_name').value = "";
                    } 
                    if (add[distKey] != null) {
                     //   document.getElementById('district_name').value = add[distKey].long_name;
                    }
                    else {
                               ...
                               zip_en: {
                                ...
                                price: {
                                 ...
                                 url:{
                                   ...
                                   maxlength:10,
                                   remote: {
                                        url: "<?php echo url('/')?>/admin/construction/checkProjectUpdateExist",
                                        type: "post",
                                        data:
                                            {
                                                projectUrl: function () {
