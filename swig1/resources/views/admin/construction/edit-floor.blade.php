...
@section('title', 'Edit Floor')
			...
			<div class="adminPageHolder adminAddPropertyHolder">
				...
				<div class="mainBoxHolder">
                                 <form action="<?php echo url('/'); ?>/admin/update-floor" method="post" id="floorForm" enctype="multipart/form-data">
                                    {{ csrf_field() }} 
                                    <input autocomplete="off" type="hidden" name="projectId" id="projectId" value="<?php echo $projectId; ?>">
                                    <input autocomplete="off" type="hidden" name="floorId" id="floorId" value="<?php echo $floorList->id; ?>">
                                    ...
                                    <div class="tabWrapper tabOuterHolder">
                                        ...
                                        <div id="en" class="tabContent">
                                            <div class="row">
                                                ...
                                                <div class="col-9 mb-3">
                                                    <input autocomplete="off" class="inputStyle" type="text" placeholder="Appartment Name" name="name_en" id="name_en" value="{{$floorList->name_en}}">
                                                </div>
                                        ...
                                        <div id="ka" class="tabContent">
                                            <div class="row">
                                                ...
                                                <div class="col-9 mb-3">
                                                    <input autocomplete="off" class="inputStyle" type="text" placeholder="Appartment Name" name="name_ka" id="name_ka" value="{{$floorList->name_ka}}">
                                                </div>
                                        ...
                                        <div id="ru" class="tabContent">
                                            <div class="row">
                                                ...
                                                <div class="col-9 mb-3">
                                                    <input autocomplete="off" class="inputStyle" type="text" placeholder="Appartment Name" name="name_ru" id="name_ru" value="{{$floorList->name_ru}}">
                                                </div>
								...
								<div class="col-9 mb-3">
                                                                    <input autocomplete="off" class="inputStyle" type="text" placeholder="Floor" name="floor" id="floor" value="{{$floorList->floor_num}}">
								</div>
								<div class="col-3 mb-3">
								...
								<div class="col-9 mb-3">
                                                                    <input autocomplete="off" class="inputStyle" type="text" placeholder="sq.m" name="area" id="area" value="{{$floorList->approximate_area}}">
								</div>
								<div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">terrace area <span class="redColor">*</span></label>
								</div>
								<div class="col-9 mb-3">
                                                                    <input autocomplete="off" class="inputStyle" type="text" placeholder="sq.m" name="terrace" id="terrace" value="{{$floorList->terrace}}">
								</div>
								<div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">bedrooms <span class="redColor">*</span></label>
								</div>
								<div class="col-9 mb-3">
                                                                    <input autocomplete="off" class="inputStyle" type="number" placeholder="0" name="bedroom" id="bedroom" value="{{$floorList->no_of_beds}}">
								</div>
								<div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">bathrooms <span class="redColor">*</span></label>
								</div>
								<div class="col-9 mb-3">
                                                                    <input autocomplete="off" class="inputStyle" type="number" placeholder="0" name="bathroom" id="bathroom" value="{{$floorList->no_of_baths}}">
								</div>
              ...
              $("#floorForm").validate({
                            ...
                            rules: {
                                ...
                                floor: {
                                    required: true,
                                    remote: {
                                        url: "<?php echo url('/')?>/admin/construction/checkFloorUpdateExist",
                                        type: "post",
                                        data:
                                            {
                                                projectId: function () {
