...
@section('title', 'Add Architect')
    ...
    <div class="adminPageHolder adminAddPropertyHolder">
				...
				<form method="POST" action="<?php echo url('/'); ?>/admin/save_architect" enctype="multipart/form-data" id="addarchitect" >
        		{{ csrf_field() }}
					...
					<div class="tabWrapper tabOuterHolder">
						...
						<div id="en" class="tabContent">
							<div class="row">
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Architect Name" name="name_en" id="name_en">
								</div>
								<div class="col-3 mb-3">
								...
								<div class="col-12 mb-3">
									...
									<div>
										<textarea rows="8" class="contentTextareaStyle" placeholder="Enter content" name="description_en" id="description_en"></textarea>
									</div>
								...
								<div class="col-12 mb-3">
									...
									<div>
										<textarea rows="4" class="contentTextareaStyle" placeholder="Enter content" name="additional_description_en" id="additional_description_en"></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="ka" class="tabContent">
							<div class="row">
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Architect Name" name="name_ka" id="name_ka">
								</div>
								<div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">address <span class="redColor">*</span></label>
								</div>
								...
								<div class="col-12 mb-3">
									...
									<div>
										<textarea rows="8" class="contentTextareaStyle" placeholder="Enter content" name="description_ka" id="description_ka" ></textarea>
									</div>
								...
								<div class="col-12 mb-3">
									...
									<label class="labelStyle text-capitalize">Add more description</label>
									<div>
										<textarea rows="4" class="contentTextareaStyle" placeholder="Enter content" name="additional_description_ka" name="additional_description_ka" ></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="ru" class="tabContent">
							<div class="row">
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Architect Name" name="name_ru" id="name_ru">
								</div>
								<div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">address <span class="redColor">*</span></label>
								</div>
								...
								<div class="col-12 mb-3">
									...
									<div>
										<textarea rows="8" class="contentTextareaStyle" placeholder="Enter content" name="description_ru" id="description_ru"></textarea>
									</div>
								...
								<div class="col-12 mb-3">
									...
									<label class="labelStyle text-capitalize">Add more description</label>
									<div>
										<textarea rows="4" class="contentTextareaStyle" placeholder="Enter content" name="additional_description_ru" name="additional_description_ru"></textarea>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="mainBoxHolder">
            		<div class="row">
								...
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Enter Phone" name="phone" id="phone">
								</div>
								<div class="col-3 mb-3">
									<label class="labelStyle text-capitalize">email <span class="redColor">*</span></label>
								</div>
								<div class="col-9 mb-3">
									<input class="inputStyle" type="text" placeholder="Enter Email" name="email" id="email">
								</div>
								<div class="col-3 mb-3">
                ...
                <div class="col-9 mb-3 appendGalleryElement">
							<div class="galleryAddHolder">
								<div class="galPrev">
									...
									<input class="custmFileInput"  id="gallery_upload_0" name="gallery_upload_0" type="file" onchange="previewFile_add('#gallery_upload_0', '#previewbox_previewimg_0', '405X300')"/>
							...
							<!-- <div class="appendGalleryElement"></div> -->
		</div>
