...
<div class="adminPageHolder adminAddPropertyHolder">
    ...
    <form method="POST" action="<?php echo url('/'); ?>/admin/save-property" enctype="multipart/form-data" id="addproperty" >
        {{ csrf_field() }}
                ...
                <div class="col-6 clearfix mt-3">
                    <div class="halfWidth mb-3">
                     ...
                     <div class="halfWidth mb-2 pr-3 relative">
                        <div class="checkboxStyleHolder mt-2">
                            <input id="new_property" name="new_property" type="checkbox" value='1'>
                    ...
                    <div class="halfWidth mt-2 mb-3 pr-3 relative">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="parking1" name="parking" type="radio" value="1">
                            <label for="parking1"><span>yes</span></label>
                        </div>
                        <div class="radioCheckStyleHolder float-left">
                            <input id="parking2" name="parking" type="radio" value="2">
        ...
        <div class="mainBoxHolder">
            ...
            <div class="row text-capitalize mt-4">
                <div class="col-6">
                    ...
                    <div class="halfWidth mb-3">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="planning_permits1" name="planning_permits" type="radio" checked="checked">
                    ...
                    <div class="halfWidth mb-3">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="subpoenas1" name="subpoenas" type="radio" checked="checked">
                    ...
                    <div class="halfWidth mb-3">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="judicial_sayings1" name="judicial_sayings" type="radio" checked="checked">
                    ...
                    <div class="halfWidth mb-3">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="pre_emption_right1" name="pre_emption_right" type="radio" checked="checked">
                    ...
                    <div class="halfWidth mb-3">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="subdivision_permit1" name="subdivision_permit" type="radio" checked="checked">
                    ...
                    <div class="halfWidth mb-3">
                        <div class="radioCheckStyleHolder float-left">
                            <input id="flood_area1" name="flood_area" type="radio" checked="checked">
