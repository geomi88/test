...
<div class="contentHolderV1">
    ...
    <div class="searchWrapper">
        <form class="searchArea" action="{{ action('Products\ProductsController@search') }}" method="post">
            {{ csrf_field() }}
            <input type="text" id="search_key" placeholder="Search by Name,Price or Seller Name" name="search_key" value="{{ $query }}">
            <input type="submit" value="Search" class="commonButton search">
            <div class="customClear"></div>
        </form>
        <a  href="{{ URL::to('products') }}" title="SetUp" class="btnReset">RESET</a>
        <div class="customClear"></div>
