...
<div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 ">
					<div class="allListBoxHolder eqHeightInner">
                                            ...
                                            <?php
                                                            ...
                                                            ?> 
                                            <a href="{{ URL::to('owner/property-view', ['id' => Crypt::encrypt($property->id)]) }}">
						...
						<div class="listContentHolder relative">
							...
							<div class="dropdownWrapper">
								<span class="listEditOption dropClick">
                                                                    <img src="{{URL::asset('owner')}}/images/iconGrayDot.png">
                                                                </span>
								<ul class="list-unstyled listEditDropdown dropdownOpen">
									<li>
										<a href="{{ URL::to('owner/property-view', ['id' => Crypt::encrypt($property->id)]) }}"><img class="img-fluid" src="{{URL::asset('owner')}}/images/iconView.png"></a>
									</li>
									<li>
										<a href="{{ URL::to('owner/property-edit', ['id' => Crypt::encrypt($property->id)]) }}"><img class="img-fluid" src="{{URL::asset('owner')}}/images/iconEdit.png"></a>
									</li>
									<li>
										<a onclick="return confirmation()" href="{{ URL::to('owner/property-remove', ['id' => Crypt::encrypt($property->id)]) }}"><img class="img-fluid" src="{{URL::asset('owner')}}/images/iconDel.png"></a>
									</li>
								</ul>
							</div>
							<div class="addressWrap">
								<figure><img src="{{URL::asset('owner')}}/images/iconMap.png"></figure>
							...
							<p>	<a href="{{ URL::to('owner/property-view', ['id' => Crypt::encrypt($property->id)]) }}">read more</a>
							</p>
