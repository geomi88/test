			...
			<div class="mainBoxHolder">
				<div class="tabWrapper tabOuterHolder">
					...
					<div id="en" class="tabContent">
						...
						<div class="mt-2">
						<a href="{{ URL::to('agent/property-edit', ['id' => Crypt::encrypt($property->id)]) }}">
							<a href="{{ URL::to('owner/property-edit', ['id' => Crypt::encrypt($property->id)]) }}">
								<button type="button" class="btnStyle mr-1">edit details</button>
							</a>		
							<a class="actnIcons" href="{{ URL::to('owner/property-listing') }}">
