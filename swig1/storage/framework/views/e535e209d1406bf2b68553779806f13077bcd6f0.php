    ...
    <table style="width: 100%;" class="tableV1" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <?php $n = $ads->perPage() * ($ads->currentPage() - 1); ?>
                ...
                <tr>
                    <td><?php echo e($n); ?></td>
                    <td><?php echo e($ad->adLocation); ?></td>
                    <td><?php echo e($ad->url); ?></td>
                    <td><?php echo e($ad->created_at); ?></td>
                    
                    <td class="actionHolder">
                        <a class="actionBtn view" href="<?php echo e(URL::to('ads/view', ['id' => ($ad->id)])); ?>" title="Edit"></a>
                        <a class="actionBtn edit" href="<?php echo e(URL::to('ads/edit', ['id' => ($ad->id)])); ?>" title="Delete"></a>
                    </td>
