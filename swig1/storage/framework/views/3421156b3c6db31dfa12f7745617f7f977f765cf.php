...
<div class="contentHolderV1">
    ...
    <div class="searchWrapper">
        <form class="searchArea" id="productSearch" action="<?php echo e(action('Products\ProductsController@searchdeals')); ?>" method="post">
        ...
        <a  href="<?php echo e(URL::to('products/deals')); ?>" title="SetUp" class="btnReset">RESET</a>
        <div class="customClear"></div>
        <form class="searchArea" id="deals" action="<?php echo e(action('Products\ProductsController@deals')); ?>" method="post">
            <?php echo e(csrf_field()); ?>

            <label class="dealschkbox"><input type="checkbox" name="deal_chk" id="deal_chk" checked> Show Deals</label>
        </form>
    </div>
