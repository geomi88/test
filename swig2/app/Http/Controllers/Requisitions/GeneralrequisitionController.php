...
class GeneralrequisitionController extends Controller {
    ...
    public function add(){
        try {
            ...
            return view('requisitions/general_requisition/create',array('requisitioncode'=>$requisitioncode));
        } catch (\Exception $e) {
    ...
    public function store(){ 
        try { 
            ...
            $arrApprover = $common->getNextLevelApprover("General Requisition",1,$created_by);
            ...
            $result=$common->notifyNextActionTaker("General Requisition",$title,$to,$requisition_id,1);
    ...
    public function view($id) {
        try{
            ...
            return view('requisitions/general_requisition/view',array('pageData'=>$pageData,'documents'=>$documents));
    ...
    public function action_view($id) {
        try {
            ...
            return view('requisitions/general_requisition/action_view',array('pageData'=>$pageData,'isactiontaken'=>$isactiontaken,'documents'=>$documents)); 
    ...
    public function approve_requisition() {
        try {
           if (Session::get('login_id')) {
            ...
            $arrApprover = $common->getNextLevelApprover("General Requisition",$next_level,$requisition_data->created_by);
...
//            }
            ...
            if($arrApprover['approver_id']!=null){
                $to=$arrApprover['approver_id'];
                $result=$common->notifyNextActionTaker("General Requisition",$title,$to,$requisition_id,2);
            }

            $to1=$requisition_data->created_by;
            $result=$common->notifyCreatedBy("General Requisition",$title,$to1,$requisition_id,1);
    ...
    public function reject_requisition() {
        try {
            ...
            $result=$common->notifyCreatedBy("General Requisition",$title,$to,$requisition_id,2);
