...
class ImportpurchaserequisitionController extends Controller {
    ...
    public function add() {
        try {
            ...
            return view('requisitions/import_purchase_requisition/add', array('suppliers'=>$suppliers,'requisitioncode'=>$requisitioncode));
        } catch (\Exception $e) {
    ...
    public function store() {
        try {
            ...
            $arrApprover = $common->getNextLevelApprover("Import Purchase Requisition",1,$created_by);
            ...
            $result=$common->notifyNextActionTaker("Import Purchase Requisition",$title,$to,$requisition_id,1);
    ...
    public function view($id) {
       ...
       //     $arrMonthQuarter = array("01" => 1, "02" => 1, "03" => 1, "04" => 2, "05" => 2, "06" => 2, "07" => 3, "08" => 3, "09" => 3, "10" => 4, "11" => 4, "12" => 4);
           ...
           // $Quarter = $arrMonthQuarter["$Month"];
            ...
            return view('requisitions/import_purchase_requisition/view', array('requisitiondata'=>$requisitiondata,'requisition_items'=>$requisition_items,'action_takers'=>$action_takers,'next_action_takers_list'=>$next_action_takers_list,'supplierdata'=>$supplier,'budgetdata'=>$budgetdata,'documents'=>$documents));
        } catch (\Exception $e) {
            Toastr::error('Sorry There Was Some Problem!', $title = null, $options = []);
    ...
    public function approve_requisition() {
        try {
            ...
            $arrApprover = $common->getNextLevelApprover("Import Purchase Requisition",$next_level,$requisition_data->created_by);
            ...
            if($arrApprover['status']==4 && $arrApprover['makePurchaseOrder']==1){
                ...
                $result3 = $payment->generatePurchaseOrder($requisition_id,3);
            }
            ...
            if($arrApprover['approver_id']!=null){
                $to=$arrApprover['approver_id'];
                $result=$common->notifyNextActionTaker("Import Purchase Requisition",$title,$to,$requisition_id,2);
            }

            $to1=$requisition_data->created_by;
            $result=$common->notifyCreatedBy("Import Purchase Requisition",$title,$to1,$requisition_id,1);
    ...
    public function reject_requisition() {
        try {
            ...
            $result=$common->notifyCreatedBy("Import Purchase Requisition",$title,$to,$requisition_id,2);
