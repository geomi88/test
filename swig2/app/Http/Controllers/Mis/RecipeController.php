...
class RecipeController extends Controller
{
     public function index() {
                            ...
                            ->where('documents.document_type', '=', 'RECIPE')
                            ->where('documents.document_owner_type', '=', 'RECIPE')
                            ->where('documents.status', '!=', 2)                            
                            ->paginate($paginate);
                             return view('mis/recipe/index',array('companies' => $companies,'documents' => $documents));
   }
