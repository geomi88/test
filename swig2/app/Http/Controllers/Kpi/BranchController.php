...
//                $row['x'] = $date->getTimestamp()*1000;
    ...
    public function contactpersons() {
        ...
        foreach ($branch_contact_persons as $branch_contact_person) {
            echo '<div class="empList">
                    <figure class="imgHolder">
                        <img src="' . $branch_contact_person->profilepic . '" alt="Profile">
                    </figure>
                    <div class="details">
                        <b>' . $branch_contact_person->first_name . ' ' . $branch_contact_person->alias_name . '</b>
                        <p>Designation : <span>' . str_replace("_", " ", $branch_contact_person->resource_type) . '</span></p>

                    </div>
                    <div class="customClear"></div>
                    <figure class="flagHolder">
                        <img src="' . $web_url . '/images/flags/' . $branch_contact_person->flag_pic . '" alt="Flag">
