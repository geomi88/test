...
class BranchsalesController extends Controller {
    ...
    public function index() {
        ...
        $loggedin_details = DB::table('employees')
                ...
                ->first();
        $user_sub_modules = Usermodule::where('employee_id', Session::get('login_id'))->join('modules', 'modules.id', '=', 'user_modules.module_id')->whereRaw("modules.parent_id in (select id from modules where name='Branch Sales')")->get();
