            ...
            <tr>
                <td style="padding: 0 25px;">
                    <table max-width="100%" border="0" cellspacing="0" cellpadding="0" style="background: #fff; display: block; min-height: 408px;">
                        <tr>
                            <td style="padding:31px 0 0 41px;"><p>Hi AREA MANAGER <b style="color: #851e32;">{{$first_name}}</b>,</p></td>
                        </tr>
                        <tr>
                            <td style="padding:18px 41px 0 41px;font-size: 16px; line-height: 25px;">
                                <p>Congratulations! You are allocated for a new area. Please check the new area and other details. </p>
                                    
                                    
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:31px 0 0 41px; font-weight: bold;"><p>We would like you to assign for a new area.</p></td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:22px 41px 0 41px;">
                                <table max-width="100%" border="0" cellspacing="0" cellpadding="0" style="width: 100%; border: 1px solid #adadad; font-size: 15px;">
                                    <tr>
                                        <td style="background: #fff0f3;padding:12px;border-right: 1px solid #adadad; border-bottom: 1px solid #adadad;">Region Name:</td>
                                        <td style="padding:12px; border-bottom: 1px solid #adadad;">{{$area_name}}</td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td style="padding:18px 41px 26px 41px;font-size: 16px; line-height: 25px;font-style: italic;">
                                <p><a href="{{$web_url}}" style="color: #1c74ec; text-decoration: underline;">Click Here </a> and get started! With the new area login. </p>
                                <p>We wish you for a good time in this new area & may your new environment will be more exciting and fun.  </p>
