...
<div class="contentHolderV1">
    <h1>Edit Category</h1>
        ...
        <form method="post" action="{{ action('Category\CategoryController@update') }}" id="upatecategoryform" enctype="multipart/form-data" class="formTypeV1">
            {{ csrf_field() }}
            ...
            <div class="formSection">
                ...
                <input type="text" name="categoryName" id="categoryName" value="{{$category_details->name}}">
                ...
                <label>Image</label>
                <img src="<?php echo url('/');?>{{$category_details->image}}" style="width:150px;height:150px;">
