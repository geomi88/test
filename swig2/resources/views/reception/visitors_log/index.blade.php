...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        $('.takePrint').click(function () {
            ...
            if (!$("#slno").is(':checked') && !$("#visitorName").is(':checked') && !$("#logdate").is(':checked') && !$("#logemp").is(':checked') && !$("#lodpurp").is(':checked')) {
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('reception/visitors_log/exportdata') }}" method="post">
        ...
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-12">
                    <a href="{{ action('Reception\ReceptionController@add') }}" class="right commonBtn commonBtn bgGreen addBtn">Create</a>
                </div>
            </div>
                ...
                <div id="tblregion">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="logbody" id='logbody'>
                            @include('reception/visitors_log/result')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            window.location.href = '{{url("reception/visitors_log")}}';
        });
