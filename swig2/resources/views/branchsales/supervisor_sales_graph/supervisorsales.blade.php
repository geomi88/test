...
<script>
    ...
    win.document.write(strStyle+ '<div style="text-align:center;"><h1>Supervisor Sales Report</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('branchsales/exportsupervisorsales') }}" method="post">
    <header class="pageTitle">
        <h1>Supervisor Sales <span>Report</span></h1>
    </header>
...
<!--                                    <select class="searchbycategory" name="searchbycategory">
                    ...
                    <tbody class="reportbody" id='reportbody'>
                        @include('branchsales/supervisor_sales_graph/result')
                    </tbody>
...
<script>
    ...
    $(function () {
        ...
        $('#sortordbranch').val('');
            ...
            $('#page-limit').val(10);
            // window.location.href = '{{url("branchsales/getSupervisorSalesDetails")}}';
            search();
        });
    });
