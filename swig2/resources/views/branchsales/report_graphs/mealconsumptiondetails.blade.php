...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        if(!$("#employeeCode").is(':checked')&&!$("#employeeName").is(':checked')&&!$("#branch").is(':checked')&&!$("#date").is(':checked')&&!$("#jobShift").is(':checked')&&!$("#amount").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#jobShift").is(':checked')){
              strStyle+=' .sales_job_shift {display:none;}';   
         }
    ...
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Meal Consumption Details</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            ...
                                            '<td style="padding:10px 0;color:#fff;" class="sales_job_shift"> Shift Name  </td>'+
    ...
    function getData(page) {
        ...
        var sortordshift = $('#sortordshift').val();
        ...
        $.ajax(
            {
                ...
                type: "get",
                datatype: "html",
                data: {searchbycode: searchbycode, search_key: search_key, sortordname: sortordname,sortordcode:sortordcode,sortordbranch:sortordbranch,sortorddate:sortorddate,sortordamnt:sortordamnt,pagelimit: pagelimit, searchable: searchable,branch_id:branch_id,from_date:from_date,to_date:to_date,sortordshift:sortordshift},
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('branchsales/exportMealConsumptionDetails') }}" method="post">
    <header class="pageTitle">
        <h1>Meal Consumption <span>Details</span></h1>
    </header>
    ...
    <div class="printChoose">
                        ...
                        <div class="custRow">
                            ...
                            <div class="custCol-4">
                                <div class="commonCheckHolder checkRender">
                                    <label>
                                        <input id="jobShift" checked="" type="checkbox">
                                        <span></span>
                                        <em>Job Shift</em>
                                    </label>
                                </div>
    ...
    <div class="listerType1 reportLister"> 
            <input type="hidden" value="{{$branch_id}}" id="branch_id" name="branch_id">
            ...
            <input type="hidden" value="" id="sortordshift" name="sortordshift">
...
<!--                            <td>
                           ...
                           <td>
                                Job Shift
                                <div class="sort">
                                    <a href="javascript:void(0)" class="btnUp shiftup"></a>
                                    <a href="javascript:void(0)" class="btnDown shiftdown"></a>
                                </div>
                            </td>
...
<!--                                    <select class="searchbycategory" name="searchbycategory">
                    ...
                    <tbody class="reportbody" id='reportbody'>
                        @include('branchsales/report_graphs/mealconsumption_result')
                    </tbody>
