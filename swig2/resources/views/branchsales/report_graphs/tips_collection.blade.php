...
<div class="infoBarV1 supervisorsalesgraph">
    <form action="{{ url('branchsales/getcashiertipscollection') }}" method="post" id="frmsupervisorgraph">
    <div class="leftSection">
        ...
        <div class="totalCount">
            <ul>
                ...
                <li>Total Tip Collection :<span>{{$actualsale}}</span></li>
            </ul>
...
<script>
   ...
   Highcharts.setOptions({
    ...
    Highcharts.chart('supervisor_wise_sales', {
        ...
        title: {
            text: 'Tip Collection By Cashier'
        },
    ...
    $("#from_date").datepicker({
     ...
     function getSalesDetails(empid, from_date, to_date, region_id) {
        ...
        form.action = "<?php  echo url('branchsales/getCashierTipsDetails'); ?>";
        form.method = "post";
        form.target="_blank";
