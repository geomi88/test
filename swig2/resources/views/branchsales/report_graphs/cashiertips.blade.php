...
<script>
    ...
    win.document.write(strStyle+ '<div style="text-align:center;"><h1>Cashier Tips Collection Report</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('branchsales/exportcashiertips') }}" method="post">
    <header class="pageTitle">
        <h1>Cashier Tips Collection <span>Report</span></h1>
    </header>
