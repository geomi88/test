...
<div class="infoBarV1 supervisorsalesgraph">
    <form action="{{ url('branchsales/getcardsale') }}" method="post" id="frmsupervisorgraph">
    <div class="leftSection">
        ...
        <div class="totalCount">
            <ul>
                ...
                <li>Total Card Sales:<span>{{$actualsale}}</span></li>
            </ul>
...
<script>
    ...
    $("#from_date").datepicker({
     ...
     function getSalesDetails(empid, from_date, to_date, region_id) {
        ...
        form.action = "<?php  echo url('branchsales/getCardDetails'); ?>";
        form.method = "post";
        form.target="_blank";
