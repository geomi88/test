...
<div class="infoBarV1 supervisorsalesgraph">
    <form action="{{ url('branchsales/getcreditfreesale') }}" method="post" id="frmsupervisorgraph">
    <div class="leftSection">
        ...
        <div class="totalCount">
            <ul>
                ...
                <li>Total Credit And Free Sale :<span>{{$actualsale}}</span></li>
            </ul>
...
<script>
    ...
    function getSalesDetails(empid, from_date, to_date, region_id) {
        ...
        form.action = "<?php  echo url('branchsales/getCreditDetails'); ?>";
        form.method = "post";
        form.target="_blank";
