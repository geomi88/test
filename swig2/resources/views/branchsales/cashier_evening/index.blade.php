...
$(document).ready(function()
{
     ...
     $('.takePrint').click(function () {
        ...
        if(!$("#employeeCodee").is(':checked')&&!$("#employeeName").is(':checked')&&!$("#branchh").is(':checked')&&!$("#regionn").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#employeeCodee").is(':checked')){
                strStyle+=' .eve_code {display:none;}';
         }
         if(!$("#employeeName").is(':checked')){
                strStyle+=' .eve_name {display:none;}';
         }
         if(!$("#branchh").is(':checked')){
               strStyle+=' .eve_branch {display:none;}';
         }
         if(!$("#regionn").is(':checked')){
              strStyle+=' .eve_region {display:none;}';  
         } 
         strStyle+='.actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;}</style>';
         
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Cashier in Duty Evening Shift</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">' +
                    '<tr class="headingHolder">' +
                    '<td style="padding:10px 0;color:#fff;" class="eve_code"> Employee Code</td>' +
                    '<td style="padding:10px 0;color:#fff;" class="eve_name"> Employee Name</td>' +
                    '<td style="padding:10px 0;color:#fff;" class="eve_branch"> Branch </td>' +
                    '<td style="padding:10px 0;color:#fff;" class="eve_region"> Region </td>' +
                    '</tr>' +
...
<div class="innerContent">
  <form id="pdfgenerator" action="{{ url('branchsales/exportdata') }}" method="post">
   
    <header class="pageTitle">
        <h1>Cashier in Duty <span>Evening Shift</span></h1>
    </header>
        ...
        <div class="listerType1 reportLister"> 
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tbody class="cashier_list" id='cashier_list'>
                           @include('branchsales/cashier_evening/searchresults')
                </tbody>
...
$('#reset').click(function () {
           ...
           // search();
           window.location.href = '{{url("branchsales/cashier_evening_shift")}}';
        });
