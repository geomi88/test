    ...
    $(document).ready(function ()
    {
        ...
        $('.print').click(function () {
            ...
            win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}'+
                    ...
                    '<div style="text-align:center;"><h1> Training Performance Report (New Employees)</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
        ...
        $.ajax(
                {
                    ...
                    type: "get",
                    datatype: "html",
                    data: {empcode: empcode,sortordexceptional:sortordexceptional,sortordeffective:sortordeffective,sortordinconsis:sortordinconsis,sortordunsatisfact:sortordunsatisfact,sortordnotaccept:sortordnotaccept,pagelimit: pagelimit},
                    // {
...
<div class="innerContent">
    <form id="pdfgenerator" action="" >
        <header class="pageTitle">
            <h1>Training Performance Report<span> (New Employees)</span></h1>
        </header>	
                ...
                <div id="tblregion">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="logbody" id='logbody'>
                            @include('training/punch_report/newresult')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            window.location.href = '{{url("training/punchreportnew")}}';
        });
