...
<div class="innerContent">
    ...
    <div class="formListV1 clsparentdiv">
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                         <div class="inputHolder">
                             ...
                             <input type="text" name="first_name" id="first_name" placeholder="Enter Company Name" maxlength="200">
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <input type="text" name="contact_number" id="contact_number" placeholder="Enter Office Telephone" maxlength="20">
                ...
                <div class="stepFields">
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="bank_name" id="bank_name" placeholder="Enter Bank Name" maxlength="200">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>City</label>
                                <input type="text" name="bank_city" id="bank_city"  placeholder="Enter City" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="cr_number" id="cr_number"  placeholder="Enter CR Number" maxlength="50">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="formListV1Dtl" id="step4" style="display: none;">
            ...
            <form action="{{url('suppliers/upload_documents')}}" method="post" id="docuform" enctype='multipart/form-data'>
                <div class="formRange">
                    <ul>
                        <li class="selected"><span>1</span></li>
                        <li class="selected"><span>2</span></li>
