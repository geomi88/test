...
$(document).ready(function()
{
    ...
    $('.takePrint').click(function () {
        ...
        if(!$("#slNo").is(':checked')&&!$("#supplierCode").is(':checked')&&!$("#supplierName").is(':checked')&&!$("#countryy").is(':checked')&&!$("#mailid").is(':checked')&&!$("#phno").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#countryy").is(':checked')){
              strStyle+=' .country_name {display:none;}';  
         } 
         if(!$("#mailid").is(':checked')){
              strStyle+=' .supplier_email {display:none;}';   
         }
         if(!$("#phno").is(':checked')){
               strStyle+=' .supplier_phno {display:none;}';   
         }
         strStyle+='.actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;}</style>';
         
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Suppliers List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
				'<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
					'<tr class="headingHolder">'+
                                            '<td style="padding:10px 0;color:#fff;" class="sl_no"> Sl No.</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="supplier_code"> Supplier Code</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="supplier_name"> Company Name</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="country_name"> Country</td>'+
                                           '<td style="padding:10px 0;color:#fff;" class="supplier_email"> Mail ID</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="supplier_phno"> Phone Number</td>'+
...
<div class="innerContent">
 ...
 <form  id="pdfgenerator" action="{{ url('suppliers/exportdataedit') }}" method="post">
    <header class="pageTitle">
        <h1>Suppliers <span>List</span></h1>
    </header>
        ...
        <div class="listerType1 reportLister"> 
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <thead class="listHeaderBottom">
                    ...
                    <tr class="headingHolder">
                        ...
                        <td class="filterFields">
                            <div class="custRow">
                                <div class="custCol-12">
                                    <input type="text" id="search_name" name="search_name" placeholder="Enter Company Name">
                                </div>
                            </div>
                        </td>
                ...
                <tbody class="supplier_list" id='supplier_list'>
                   @include('ledgers/suppliers/editresults')
                </tbody>
