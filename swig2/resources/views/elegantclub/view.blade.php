...
<div class="innerContent">
    <header class="pageTitle">
        <h1>View <span>Corporate Customer</span></h1>
    </header>
                    ...
                    <div class="custRow">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <select class="chosen-select " name="created_by_id" id="created_by_id" disabled>
...
<!--                        <div class="inputHolder">
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="name_english" id="name_english" readonly="readonly" autocomplete="off" placeholder="Enter Customer Name" value="{{$elegantcustomer->name_english}}" maxlength="200">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="name_arabic" id="name_arabic" readonly="readonly"  autocomplete="off" placeholder="أدخل اسم العميل" value="{{$elegantcustomer->name_arabic}}" maxlength="200">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-5">
                            <div class="inputHolder bgSelect fieldMargin">
                                ...
                                <div class="commonCheckHolder radioRender">
                                    <label>
                                        <input type="radio" class="customer_type" name="customer_type" id="customer_type" value="0" <?php if ($elegantcustomer->customer_type==0) { echo "checked";} ?> disabled>
                                        <span></span>
                                        <em>Saudi</em>
                                    </label>
                                </div>
                                <div class="commonCheckHolder radioRender">
                                    <label>
                                        <input type="radio" class="customer_type" name="customer_type" id="customer_type" value="1" <?php if ($elegantcustomer->customer_type==1) { echo "checked";} ?> disabled>
                                        <span></span>
                                        <em>International</em>
                                    </label>
                                </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <input type="text" name="cr_number" id="cr_number" placeholder="Enter CR Number" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->cr_number}}" maxlength="20">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>VAT Number</label>
                                <input type="text" name="vat_number" id="vat_number" placeholder="Enter VAT Number" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->vat_number}}" maxlength="20">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>P.O Box</label>
                                <input type="text" name="po_box" id="po_box" placeholder="Enter P.O Box" autocomplete="off" readonly="readonly" value="{{$elegantcustomer->po_box}}" maxlength="20">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <input type="text" name="building_name" id="building_name" placeholder="Enter Building Name" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->building_name}}" maxlength="200">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Street Name</label>
                                <input type="text" name="street_name" id="street_name" placeholder="Enter Street Name" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->street_name}}" maxlength="200">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>City</label>
                                <input type="text" name="city" id="city" placeholder="Enter City" autocomplete="off" readonly="readonly" value="{{$elegantcustomer->city}}" maxlength="200">
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <textarea name="detail_address" id="detail_address" placeholder="Enter Detail Address" readonly="readonly">{{$elegantcustomer->detail_address}}</textarea>
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Google Map - Latitude</label>
                                <input type="text" name="latitude" id="latitude" class="numberwithdot" placeholder="Enter Latitude" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->latitude}}" maxlength="30">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Google Map - Longitude</label>
                                <input type="text" name="longitude" id="longitude" class="numberwithdot" placeholder="Enter Longitude" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->longitude}}" maxlength="30">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Company Website</label>
                                <input type="text" name="website" id="website" placeholder="Enter Company Website" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->website}}" maxlength="100">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Business Type</label>
                                <select class="chosen-select" name="business_type" id="business_type" disabled>
                    ...
                    <div class="custRow">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <textarea name="nature_of_current_business" id="nature_of_current_business" readonly="readonly" placeholder="Enter Nature of Current Business">{{$elegantcustomer->nature_of_current_business}}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="stepFields">
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="contact_person" id="contact_person" placeholder="Enter Contact Person" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->contact_person}}" maxlength="150">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="mobile_1" id="mobile_1" onkeypress="return isNumberKey(event)" autocomplete="off"  placeholder="Enter Mobile Number 1" readonly="readonly" value="{{$elegantcustomer->mobile_1}}" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="mobile_2" id="mobile_2" onkeypress="return isNumberKey(event)" autocomplete="off" placeholder="Enter Mobile Number 2" readonly="readonly" value="{{$elegantcustomer->mobile_2}}" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="land_phone" id="land_phone" onkeypress="return isNumberKey(event)" placeholder="Enter Land Phone Number" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->land_phone}}" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <select name="nationality_contact_person" id="nationality_contact_person" disabled>
                                    <option value=''>Choose Nationality</option>
                                    @foreach ($countries as $country)
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>Email 1</label>
                                <input type="text" name="email_1" id="email_1"  placeholder="Enter Email 1" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->email_1}}" maxlength="50">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>Email 2</label>
                                <input type="text" name="email_2" id="email_2" placeholder="Enter Email_2" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->email_2}}" maxlength="50">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="job_position"  id="job_position"  placeholder="Enter Job Position" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->job_position}}" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="id_number"  id="id_number"  placeholder="Enter ID Number" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->id_number}}" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow'">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" class="numberwithdot" name="busines_target_per_month"  id="busines_target_per_month"  placeholder="Enter Business Target per Month" readonly="readonly" autocomplete="off" value="{{$elegantcustomer->busines_target_per_month}}" maxlength="30">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-8">
                            <div class="inputHolder">
                                ...
                                <textarea name="interested_products" id="interested_products" readonly="readonly" placeholder="Enter Interested Products">{{$elegantcustomer->interested_products}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-8">
                            <div class="inputHolder">
                                ...
                                <textarea name="comments_from_customer" id="comments_from_customer" readonly="readonly" placeholder="Enter Comments from Customer">{{$elegantcustomer->comments_from_customer}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-8">
                            <div class="inputHolder">
                                ...
                                <textarea name="comments_about_customer" id="comments_about_customer" readonly="readonly" placeholder="Enter Comments about this customer">{{$elegantcustomer->comments_about_customer}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="formListV1Dtl" id="step4" style="display: none;">
            ...
            <form action="{{url('elegantclub/list_corporate_customer')}}" method="post" id="docuform" enctype='multipart/form-data'>
                <div class="formRange">
                    <ul>
                        <li class="selected"><span>1</span></li>
                        <li class="selected"><span>2</span></li>
