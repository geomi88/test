...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Add <span>Corporate Customer</span></h1>
    </header>
    ...
    <div class="formListV1 clsparentdiv">
            ...
            <div class="formListV1Dtl" id="step1">
                ...
                <div class="fieldGroup" id="fieldSet1">
                    ...
                    <div class="custRow">
                        ...
                        <input type="hidden" name="created_by_id" id="created_by_id" value="{{$loggedin_employee_details->id}}">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>Employee Code</label>
                                <input type="text" name="employee_code" id="employee_code" readonly="readonly" value="{{$loggedin_employee_details->username}}">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="employee_name" id="employee_name" readonly="readonly" value="{{$loggedin_employee_details->first_name}}">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="customer_code" id="customer_code" readonly="readonly" value="{{$customer_code}}">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="name_english" id="name_english" autocomplete="off" placeholder="Enter Customer Name" maxlength="200">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="name_arabic" id="name_arabic"  autocomplete="off" placeholder="أدخل اسم العميل" maxlength="200">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-5">
                            <div class="inputHolder bgSelect fieldMargin">
                                ...
                                <div class="commonCheckHolder radioRender">
                                    <label>
                                        <input type="radio" class="customer_type" name="customer_type" id="customer_type" value="0" checked >
                                        <span></span>
                                        <em>Saudi</em>
                                    </label>
                                </div>
                                <div class="commonCheckHolder radioRender">
                                    <label>
                                        <input type="radio" class="customer_type" name="customer_type" id="customer_type" value="1" >
                                        <span></span>
                                        <em>International</em>
                                    </label>
                                </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <input type="text" name="cr_number" id="cr_number" placeholder="Enter CR Number" autocomplete="off" maxlength="20">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>VAT Number</label>
                                <input type="text" name="vat_number" id="vat_number" placeholder="Enter VAT Number" autocomplete="off" maxlength="20">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>P.O Box</label>
                                <input type="text" name="po_box" id="po_box" placeholder="Enter P.O Box" autocomplete="off" maxlength="20">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                ...
                                <input type="text" name="building_name" id="building_name" placeholder="Enter Building Name" autocomplete="off" maxlength="200">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Street Name</label>
                                <input type="text" name="street_name" id="street_name" placeholder="Enter Street Name" autocomplete="off" maxlength="200">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>City</label>
                                <input type="text" name="city" id="city" placeholder="Enter City" autocomplete="off" maxlength="200">
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <textarea name="detail_address" id="detail_address" placeholder="Enter Detail Address"></textarea>
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Google Map - Latitude</label>
                                <input type="text" name="latitude" id="latitude" class="numberwithdot" placeholder="Enter Latitude" autocomplete="off" maxlength="30">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Google Map - Longitude</label>
                                <input type="text" name="longitude" id="longitude" class="numberwithdot" placeholder="Enter Longitude" autocomplete="off" maxlength="30">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                                <label>Company Website</label>
                                <input type="text" name="website" id="website" placeholder="Enter Company Website" autocomplete="off" maxlength="100">
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder mobile">
                    ...
                    <div class="custRow">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <textarea name="nature_of_current_business" id="nature_of_current_business" placeholder="Enter Nature of Current Business"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="stepFields">
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="contact_person" id="contact_person" placeholder="Enter Contact Person" autocomplete="off" maxlength="150">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="mobile_1" id="mobile_1" onkeypress="return isNumberKey(event)"  placeholder="Enter Mobile Number 1" autocomplete="off" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="mobile_2" id="mobile_2" onkeypress="return isNumberKey(event)" placeholder="Enter Mobile Number 2" autocomplete="off" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="land_phone" id="land_phone" onkeypress="return isNumberKey(event)" placeholder="Enter Land Phone Number" autocomplete="off" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>Email 1</label>
                                <input type="text" name="email_1" id="email_1"  placeholder="Enter Email 1" autocomplete="off" maxlength="50">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow">
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                <label>Email 2</label>
                                <input type="text" name="email_2" id="email_2" placeholder="Enter Email_2" autocomplete="off" maxlength="50">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        ...
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="job_position"  id="job_position"  placeholder="Enter Job Position" autocomplete="off" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" name="id_number"  id="id_number"  placeholder="Enter ID Number" autocomplete="off" maxlength="100">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    ...
                    <div class="custRow'">
                        <div class="custCol-4">
                            <div class="inputHolder">
                                ...
                                <input type="text" class="numberwithdot" name="busines_target_per_month"  id="busines_target_per_month"  placeholder="Enter Business Target per Month" autocomplete="off" maxlength="30">
                                <span class="commonError"></span>
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-8">
                            <div class="inputHolder">
                                ...
                                <textarea name="interested_products" id="interested_products" placeholder="Enter Interested Products"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-8">
                            <div class="inputHolder">
                                ...
                                <textarea name="comments_from_customer" id="comments_from_customer" placeholder="Enter Comments from Customer"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="custRow">
                        <div class="custCol-8">
                            <div class="inputHolder">
                                ...
                                <textarea name="comments_about_customer" id="comments_about_customer" placeholder="Enter Comments about this customer"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="formListV1Dtl" id="step4" style="display: none;">
            ...
            <form action="{{url('elegantclub/customer/upload_documents')}}" method="post" id="docuform" enctype='multipart/form-data'>
                ...
                <div class="custRow">
                    <div class="custCol-8">                            
                        <input type="hidden" name="upload_customer_id" id="upload_customer_id" value="">
                        <div class="custRow">                                
                            <div class="custCol-6">
