...
$(document).ready(function()
{
     $(document).on('click', '.pagination a',function(event)
        ...
        if(!$("#slNo").is(':checked')&&!$("#supplierCode").is(':checked')&&!$("#createdBy").is(':checked')&&!$("#supplierName").is(':checked')&&!$("#countryy").is(':checked')&&!$("#mailId").is(':checked')&&!$("#phNo").is(':checked')&&!$("#statuss").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#createdBy").is(':checked')){
                strStyle+=' .created_by {display:none;}';
         }
    ...
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Corporate Customer List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
				'<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
					'<tr class="headingHolder">'+
                                            ...
                                            '<td style="padding:10px 0;color:#fff;" class="created_by"> Sales By</td>'+
...
function getData(page){
    ...
    $.ajax(
    {
        ...
        type: "get",
        datatype: "html",
        data: {search_name: search_name,searchbyph:searchbyph,searchbycode:searchbycode,searchbyempcode:searchbyempcode, searchbyemail:searchbyemail,country: country,sortordname:sortordname,sortordcode:sortordcode,sortordcountry:sortordcountry,pagelimit: pagelimit,status:status},
...
<div class="innerContent">
 ...
 <form  id="pdfgenerator" action="">
    <header class="pageTitle">
        <h1>Delete Corporate Customers <span>List</span></h1>
    </header>
        ...
        <div class="listerType1 reportLister"> 
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tbody class="supplier_list" id='supplier_list'>
                   @include('elegantclub/customer_list/deleteresults')
                </tbody>
...
<script>
    ...
    $('#reset').click(function () {
        ...
        $('#page-limit').val(10);
        //search();
        window.location.href = '{{url("elegantclub/delete_corporate_customer")}}';
    });
