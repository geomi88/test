...
<div class="contentHolderV1">
    ...
    <div class="searchWrapper">
        <form class="searchArea" id="productSearch" action="{{ action('Products\ProductsController@searchdeals') }}" method="post">
            {{ csrf_field() }}
        ...
        <a  href="{{ URL::to('products/deals') }}" title="SetUp" class="btnReset">RESET</a>
        <div class="customClear"></div>
