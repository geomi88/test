    ...
    $(document).ready(function ()
    {
        ...
        $('.takePrint').click(function () {
            ...
            if (!$("#slno").is(':checked') && !$("#customer_name").is(':checked') && !$("#log_date").is(':checked') && !$("#mobile_number").is(':checked') && !$("#statuss").is(':checked') && !$("#cus_branch").is(':checked') && !$("#feed_created_by").is(':checked') && !$("#customer_comments").is(':checked')) {
                ...
                win.document.write(strStyle + '<div style="text-align:center;"><h1>CRM Feedback List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('reception/visitors_list/exportdata') }}" method="post">
        <header class="pageTitle">
            <h1><span>CRM Feedback</span> List</h1>
        </header>	
                ...
                <div id="tblregion">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="logbody" id='logbody'>
                            @include('crm/all_crm_feedback/result')
                        </tbody>
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            window.location.href = '{{url("crm/all_crm_feedback")}}';
        });
