...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Edit <span>Bank</span></h1>
    </header>	

    <form action="{{ action('Masterresources\BankController@update') }}" method="post" id="bankinsertion">
        <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder areaName ">
                        <label>Area Name</label>
                        <input type="hidden" name="bank_id" value='{{$bank->id}}' id="bank_id">
                        <input type="text" name="name" value='{{$bank->name}}' id="name"  onpaste="return false;" autocomplete="off" placeholder="Enter Bank Name">
                ...
                <div class="custCol-4">
                    <div class="inputHolder">
                        <label>Alias</label>
                        <input type="text" value='{{$bank->alias_name}}' name="alias_name" id="alias_name" placeholder="Enter Alias" >
                        <span class="commonError"></span>
                    </div>
                </div>
            </div>
