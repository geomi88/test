...
<script>
    ...
    $(document).ready(function ()
    {
     ...
     $('.takePrint').click(function () {
        ...
        if(!$("#slno").is(':checked')&&!$("#officeName").is(':checked')&&!$("#alias").is(':checked')) {
    ...
    win.document.write(strStyle+ '<div style="text-align:center;"><h1>Office List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            '<td style="padding:10px 0;color:#fff;" class="dep_slno"> Sl.No.</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="dep_name"> Office Name</td>'+
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('masterresources/office/exportdata') }}" method="post">
    <header class="pageTitle">
        <h1><span>Office</span> List</h1>
    </header>	
  <!-- add department -->
         <div class="fieldGroup" id="fieldSet1">
            <div class="custRow">
                <div class="custCol-12">
                     <a href="{{ action('Masterresources\OfficeController@add') }}" id="btnNew" class="right commonBtn commonBtn bgGreen addBtn">Create</a>
                </div>
            </div>
    ...
    <div class="printChoose">
                        <div class="custRow">
                            ...
                            <div class="custCol-4">
                                <div class="commonCheckHolder checkRender">
                                    <label>
                                        <input id="officeName" checked="" type="checkbox">
                                        <span></span>
                                        <em>Office Name</em>
                                    </label>
                                </div>
            ...
            <div id="tblregion">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <thead class="listHeaderBottom">
                        ...
                        <tr class="headingHolder">
                            ...
                            <td class="filterFields">
                                <div class="custRow">
                                    <div class="custCol-12">
                                        <input type="text" id="searchbyname" name="searchbyname" placeholder="Enter Office Name">
                    ...
                    <tbody class="regionbody" id='regionbody'>
                        @include('masterresources/office/office_result')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            ...
            $('#page-limit').val(10);
            //search();
            window.location.href = '{{url("masterresources/office")}}';
        });
    });
