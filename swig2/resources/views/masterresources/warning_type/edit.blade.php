...
<div class="innerContent">
    <header class="pageTitle">
        <h1>Edit <span>Warning Type</span></h1>
    </header>	

    <form action="{{ action('Masterresources\WarningtypeController@update') }}" method="post" id="checklistcatupdation">
            ...
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder checklistcatName">
                        ...
                        <input type="text" name="name" id="name" value='{{ $categorie_datas->name }}' autocomplete="off" placeholder="Enter Warning Type" maxlength="250">
