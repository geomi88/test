...
<script>
    ...
    $(document).ready(function ()
    {
     ...
     $('.takePrint').click(function () {
        ...
        if(!$("#slno").is(':checked')&&!$("#warningType").is(':checked')&&!$("#alias").is(':checked')) {
        ...
        var strStyle='<style>.paginationHolder {display:none;}';
         ...
         if(!$("#slno").is(':checked')){
                strStyle+=' .warning_slno {display:none;}';
         }
         if(!$("#warningType").is(':checked')){
                strStyle+=' .warning_name {display:none;}';
         }
         if(!$("#alias").is(':checked')){
               strStyle+=' .warning_alias {display:none;}';
         }
        strStyle+='.actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;}</style>';
         
    win.document.write(strStyle+'<div style="text-align:center;"><h1>Warning Types</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        '<tr class="headingHolder">'+
                                            '<td style="padding:10px 0;color:#fff;" class="warning_slno"> Sl.No.</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="warning_name"> Warning Type</td>'+
                                            '<td style="padding:10px 0;color:#fff;" class="warning_alias"> Alias </td>'+
                                        '</tr>'+
...
<div class="innerContent">
    <form id="pdfgenerator" action="{{ url('masterresources/warning_type/exportdata') }}" method="post">
    ...
    <div class="fieldGroup" id="fieldSet1">
        <div class="custRow">
            <div class="custCol-12">
                <a href="{{ action('Masterresources\WarningtypeController@add') }}" id="btnNew" class="right commonBtn commonBtn bgGreen addBtn">Create</a>
            </div>
        </div>
            ...
            <div id="tblcategorytable">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <thead class="listHeaderBottom">
                        ...
                        <tr class="headingHolder">
                            ...
                            <td class="filterFields">
                                <div class="custRow">
                                    <div class="custCol-12">
                                        <input type="text" id="searchbyname" name="searchbyname" placeholder="Enter Warning Type">
                    ...
                    <tbody class="categorybody" id='categorybody'>
                        @include('masterresources/warning_type/result')
...
<script>
    ...
    $(function () {
        ...
        $('#reset').click(function () {
            ...
            $('#page-limit').val(10);
            //search();
            window.location.href = '{{url("masterresources/warning_type")}}';
        });
    });
