<?php  $n = $meetings->perPage() * ($meetings->currentPage() - 1); ?> 
    ...
    <tr>
		...
		<a class="btnAction disable bgOrange" href="{{ URL::to('meeting/view', ['id' => Crypt::encrypt($meeting->id)]) }}">View</a>
                <?php if ($meeting->owner_id == Session::get('login_id')) { ?>
                <a class="btnAction edit bgBlue" href="{{ URL::to('meeting/edit', ['id' => Crypt::encrypt($meeting->id)]) }}">Edit</a>
                <a class="btnAction delete bgLightRed" href="{{ URL::to('meeting/delete', ['id' => Crypt::encrypt($meeting->id)]) }}">Delete</a>
                <?php }  ?>
		</div>
            </div>
        </td>
<!--        <td class="btnHolder">
            <div class="actionBtnSet linkviewtodo">
                <?php if ($meeting->owner_id == Session::get('login_id')) { ?>
                <a class="btnAction action bgBlue" href="{{ URL::to('meeting/edit', ['id' => Crypt::encrypt($meeting->id)]) }}">Edit</a>
                <a class="btnAction action bgBlue" href="{{ URL::to('meeting/delete', ['id' => Crypt::encrypt($meeting->id)]) }}">Delete</a>
                <?php }  ?>
                <a class="btnAction action bgBlue" href="{{ URL::to('meeting/view', ['id' => Crypt::encrypt($meeting->id)]) }}">View</a>
