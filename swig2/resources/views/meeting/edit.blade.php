...
<div class="innerContent">
    ...
    <form action="{{ action('Meeting\MeetingController@update') }}" method="post" id="frmupdatemeeting">
        <input type="hidden" name="id" value="{{$meeting_details->id}}">
        <div class="fieldGroup meetingHolder">
            <header class="pageTitle">
                <h1>Edit <span>Meeting</span></h1>
            </header>
            ...
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder">
                        ...
                        <input type="text" name="title" id="title" value="{{$meeting_details->title}}">
                    </div>
                </div>
            </div>
