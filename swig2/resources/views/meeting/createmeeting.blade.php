...
$(document).ready(function ()
{
    ...
    $('.print').click(function () {
        ...
        win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet,.checkboxSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;}</style>' +
                '<div style="text-align:center;"><h1>Employee List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">' +
                '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">' +
                '<tr class="headingHolder">' +
                '<td style="padding:10px 0;color:#fff;"> Employee Name</td>' +
                '<td style="padding:10px 0;color:#fff;"> Job Position</td>' +
                '<td style="padding:10px 0;color:#fff;"> Employee Code </td>' +
                '<td style="padding:10px 0;color:#fff;"> New Tasks </td>' +
                '<td style="padding:10px 0;color:#fff;"> Pending Tasks </td>' +
                '</tr>' +
...
<div class="innerContent">
    ...
    <form action="{{ action('Meeting\MeetingController@savemeeting') }}" method="post" id="frmcreatemeeting">
        ...
        <div class="fieldGroup meetingHolder">
            ...
            <div class="custRow">
                ...
                <div class="empTypeDtl" id="guestEmp">
                    <div class="custRow">
                        ...
                        <div class="custCol-1">
                            <a href="javascript:void(0)" class="commonBtn bgGreen addBtn addGuestBtn">Add</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="custRow">
                <div class="custCol-4">
                    <input type="submit" value="Create" id="btnCreate" onclick="return funBeforeSubmission();" class="commonBtn bgGreen addBtn" id="sub">
                </div>
            </div>
        </div>
    </form>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(result.length>0){
                        ...
                        var msg="<h3>Meeting room "+$("#meeting_room :selected").text()+" already engaged for meetings</h3> <ul>";    
...
<script>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(result.length>0){
                            ...
                            var msg="<h3>Employee "+$("#name_"+empid).val()+" already engaged in meetings</h3><ul>";    
                            for(var i=0;i<result.length;i++){
    ...
    {
        $("#addedguestlist").html('<tr><td>No Guest Added<td></tr>');
        if (guests.length > 0) {
            var strHtml = '';
