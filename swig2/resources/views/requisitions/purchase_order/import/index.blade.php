        ...
        $('.print').click(function () {
            var pageTitle = 'Page Title',
                ...
                win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>'+
                                '<div style="text-align:center;"><h1>Import Purchase Orders</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('requisitions/exportdata_importpurchaseorder') }}" method="post">
                ...
                <div id="postable">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="order_list" id='order_list'>                  
                            @include('requisitions/purchase_order/import/results')
                        </tbody>
