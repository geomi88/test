        ...
        $('.print').click(function () {
            var pageTitle = 'Page Title',
                ...
                win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>'+
                                '<div style="text-align:center;"><h1>Payment Approval List</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
                                    '<thead style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(109, 179, 242, 1) 0%, rgba(84, 163, 238, 1) 50%, rgba(54, 144, 240, 1) 51%, rgba(30, 105, 222, 1) 100%) repeat  0 0;">'+
                                        ...
                                        '</tr>'+
                                    '</thead>'+ $('.userwiselist')[0].outerHTML +'</table>');
            win.document.close();
            win.print();
            win.close();
            return false;
        ...
        $.ajax(
                {
                    ...
                    type: "get",
                    datatype: "html",
                    data: { searchbycode:searchbycode,created_at_from:created_at_from,created_at_to:created_at_to,sortordcode:sortordcode, sortorddate:sortorddate, pagelimit: pagelimit},
                    // {
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('requisitions/exportuserwispaymentsdata') }}" method="post">
        <header class="pageTitle">
            <h1>Payment Approval<span> List</span></h1>
        </header>	
            ...
            <div class="listerType1 reportLister"> 
                ...
                <div id="postable">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="userwiselist" id='userwiselist'>                  
                            @include('requisitions/userwise_payments/results')
                        </tbody>
