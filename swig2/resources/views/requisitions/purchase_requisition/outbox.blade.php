        ...
        $('.print').click(function () {
            var pageTitle = 'Page Title',
                ...
                win.document.write('<style>.paginationHolder {display:none;} .actionBtnSet{display:none;} .listerType1 tr:nth-of-type(2n) {background: rgba(0, 75, 111, 0.12) none repeat 0 0;} .right {float: right;margin-right:20px;}</style>'+
                                '<div style="text-align:center;"><h1>Requisition Outbox</h1></div><table style="width: 100%; border: 3px solid #3088da" cellspacing="0" cellpadding="0" class="listerType1">'+
        ...
        $.ajax(
                {
                    ...
                    type: "get",
                    datatype: "html",
                    data: { searchbycode:searchbycode,searchbyname: searchbyname,sortordtype:sortordtype,searchbytype:searchbytype,created_at_from:created_at_from,created_at_to:created_at_to,sortordcode:sortordcode, sortordtitle: sortordtitle,sortorddate:sortorddate, pagelimit: pagelimit},
                    // {
...
<div class="innerContent">
    ...
    <form id="pdfgenerator" action="{{ url('requisitions/exportdataoutbox') }}" method="post">
        <header class="pageTitle">
            <h1>Requisition <span>Outbox</span></h1>
        </header>	
                ...
                <div id="postable">
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody class="outbox_list" id='outbox_list'>                  
                            @include('requisitions/purchase_requisition/outbox_results')
                        </tbody>
