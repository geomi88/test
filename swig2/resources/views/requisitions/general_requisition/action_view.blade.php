    ...
    <div class=" inputAreaWrapper">
        ...
        <div class="custRow ">
            <div class="custCol-4">
                <div class="inputHolder  ">
                    <label>Amount </label>
                    <input type="text" placeholder="Enter Amount" onpaste="return false;" id="amount" name="amount" value="">
                    <input type="hidden" id="hiddenAmount" value="{{$requisitiondata->total_price}}">
                    <span class="commonError"></span>
                </div>
            </div>
             <div class="custCol-4">
                 <label style="margin-top: 37px;">Created By : <span>{{$requisitiondata->createdby}}</span></label>
            </div>
        </div>
