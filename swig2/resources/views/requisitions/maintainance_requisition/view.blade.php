...
if($center_type == "BRANCH"){ $text = "Branch"; }
if($center_type == "OFFICE"){ $text = "Office"; }
if($center_type == "WAREHOUSE"){ $text = "Warehouse"; }
if($center_type == "STAFF_HOUSE"){ $text = "Staff House"; }
?>
<script>
...
<div style="display: none" class="printDiv">
    <table border="0" cellpadding="5" width="100%" height="100%" border="0" cellspacing="0" style="font-family:Arial, Helvetica,
                    sans-serif; font-size:12px;color:#000;border:3px solid #760000;">
        <tr>
            <td >
                <span style="color:#760000; font-size:25px;font-weight:bold; display:block;padding-bottom:15px;">Maintenance Requisition</span>
                    ...
                    <tr>
                        ...
                        <td width="25%" style="vertical-align:top;">
                            <table border="0" cellpadding="0" width="100%" height="100%" cellspacing="0"  style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                                <tr style="padding-bottom:5px;margin:0;">
                                    <td>
                                        <span style="padding-right:5px;display:inline-block;color:#000;">{{$text}} :</span>
                                        <strong style="display:inline-block;color:#000;">{{$requisitiondata->name}}</strong>
                                    </td>
                                 </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" width="100%" height="100%" cellspacing="0"  style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                                <tr style="padding-bottom:5px;margin:0;">
                                    <td>
                                        ...
                                        <strong style="display:inline-block;color:#000;"><?php echo str_replace("_", " ", $requisitiondata->job_position)?></strong>
                                    </td>
                                 </tr>
                            </table>
                        </td>
        ...
        <div class="custRow ">
            ...
            <div class="custRow">
                <div class="custCol-6">
                    ...
                    <!--<label>Job Position : <span>{{$requisitiondata->job_position}}</span></label>-->
                </div>
            </div>
        </div>
