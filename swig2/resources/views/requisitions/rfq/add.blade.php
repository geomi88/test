        ...
        <form id="frmaddrequisition" method="post" enctype="multipart/form-data">
            <div class="custRow reqCodeDateHolder">
                ...
                <div class="custCol-6 alignRight">
                    <label>RFQ Code : <span>{{$rfqcode}}</span></label>
                </div>
            </div>
            <div class="custRow ">
                <div class="custCol-4">
                    <div class="inputHolder">
                        ...
                        <input type="hidden" value="{{$rfqcode}}" id="requisition_code" name="requisition_code">
                ...
                <div class="custRow" >
                    ...
                    <div class="custCol-4">
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter terms of payment" name="payment_terms" id="payment_terms" autocomplete="off" type="text" maxlength="250">
                            <span class="commonError"></span>
                ...
                <div class="custRow">
                    ...
                    <div class="custCol-4">
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter delivery date" name="delivery_date" id="delivery_date" readonly autocomplete="off" type="text">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-4">
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter planning date" name="planning_date" id="planning_date" readonly autocomplete="off" type="text">
                            <span class="commonError"></span>
                ...
                <div class="custRow stockDiv" >
                    <div class="custCol-3" >
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter stock in hand" class="numberwithdot" name="stockinhand" id="stockinhand" autocomplete="off" type="text" maxlength="20">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-3">
                        <div class="inputHolder">
                            ...
                            <input placeholder="From date" name="stock_period_from" id="stock_period_from" readonly autocomplete="off" type="text">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-3">
                        <div class="inputHolder">
                            <label>To :</label>
                            <input placeholder="To date" name="stock_period_to" id="stock_period_to" readonly autocomplete="off" type="text">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-3" >
                        <div class="inputHolder">
                            <label>In Days:</label>
                            <input placeholder="In Days" class="numberwithdot" name="indaysstock" id="indaysstock" autocomplete="off" type="text" maxlength="20" disabled="">
                            <span class="commonError"></span>
                ...
                <div class="custRow stockDiv" >
                    <div class="custCol-3" >
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter stock total" class="numberwithdot"  name="stocktotal" id="stocktotal" readonly autocomplete="off" type="text" maxlength="20">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-3">
                        <div class="inputHolder">
                            ...
                            <input placeholder="From date" name="forecast_from" id="forecast_from" readonly autocomplete="off" type="text">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-3">
                        <div class="inputHolder">
                            ...
                            <input placeholder="To date" name="forecast_to" readonly id="forecast_to" autocomplete="off" type="text">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-3" >
                        <div class="inputHolder">
                            <label>In Days:</label>
                            <input placeholder="In Days" class="numberwithdot" name="indaysrfqstock" id="indaysrfqstock" autocomplete="off" type="text" maxlength="20" disabled="">
                            <span class="commonError"></span>
                ...
                <div class="custRow" >
                    <div class="custCol-8" >
                        <div class="inputHolder">
                            ...
                            <textarea id="productspec" name="productspec" placeholder="Enter product specification"></textarea>
                            <span class="commonError"></span>
                ...
                <div class="custRow" >
                    <div class="custCol-6">
                        <div class="inputHolder checkHolder">
                            ...
                            <div class="commonCheckHolder radioRender">
                                <label>
                                    <input  name="approvedsupplier" checked value="Yes" type="radio"   >
                                    <span></span>
                                    <em>Yes</em>
                                </label>
                            </div>
                            <div class="commonCheckHolder radioRender">
                                <label>
                                    <input  name="approvedsupplier" value="No" type="radio"  >
                                    <span></span>
                                    <em>No</em>
                                </label>
                            </div>
                ...
                <div class="custRow" >
                    <div class="custCol-4" >
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter last purchase date" readonly name="last_purchase_date" id="last_purchase_date" autocomplete="off" type="text" maxlength="10">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-4">
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter last purchase quantity" name="last_qty" id="last_qty" class="numberwithdot" autocomplete="off" type="text" maxlength="20">
                            <span class="commonError"></span>
                    ...
                    <div class="custCol-4">
                        <div class="inputHolder">
                            ...
                            <input placeholder="Enter last purchase value" name="last_value" id="last_value" class="numberwithdot" autocomplete="off" type="text">
                            <span class="commonError"></span>
...
<!--                <div class="custCol-6 ">
        ...
        <div class="custRow" style="margin-top: 10px;">
            <div class="custCol-12">
                <div class="commonCheckHolder clsRfqAgreement" style="padding-bottom: 10px;">
                    <label >
                        <input id="chkAgree" type="checkbox">
                        <span></span><em>The above RFQ I am placing with the understanding of the quantity required. All kind of checking I have done before this RFQ. I agree that details entered is 100% correct.</em>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="custRow">
            <div class="custCol-6">
                <input type="button" id="btnSaveRequisition" class="btnIcon lightGreenV3" value="Make RFQ">
            </div>
        </div>
...
//            }
            ...
            if($("#unit_id").val()==intGlobalPrimaryUnit){
                ...
                if($("#quantity").val()!=''){
                    var price = priceperunit * parseFloat($("#quantity").val());
           ...
           var arraData = {
                ...
                priceperunit: amountformat(priceperunit),
    ...
    function showproductlist() {
        ...
        if (arrProductList.length > 0) {
            ...
            strHtml+='<tr><td></td><td></td><td></td><td></td><td class="amountAlign"><strong>VAT Amount (5%)</strong></td><td class="amountAlign"><strong><input type="text" id="total_vat" value='+ totVat +' class="vatInput numberwithdot"></strong></td><td></td></tr>';
