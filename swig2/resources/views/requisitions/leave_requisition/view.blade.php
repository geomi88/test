...
<div style="display: none" class="printDiv">
    <table border="0" cellpadding="5" width="100%" height="100%" border="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;color:#000;border:3px solid #760000;">
        <tr>
            <td>
                <span style="color:#760000; font-size:25px;font-weight:bold; display:block;padding-bottom:15px;">Leave Requisition</span>
                    ...
                    <tr>
                        ...
                        <td width="33.33%" style="vertical-align:top;">
                            <table border="0" cellpadding="0" width="100%" height="100%" cellspacing="0"  style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                                <tr style="padding-bottom:5px;margin:0;">
                                    <td>
                                        <span style="padding-right:5px;display:inline-block;color:#000;">Leave Type :</span>
                                        <strong style="display:inline-block;color:#000;"><?php echo $leaveLength; ?></strong>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td width="33.33%" style="vertical-align:top;">
                            <table border="0" cellpadding="0" width="100%" height="100%" cellspacing="0"  style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                                <tr style="padding-bottom:5px;margin:0;">
                                    <td>
                                        <span style="padding-right:5px;display:inline-block;color:#000;">Date :</span>
                                        <strong style="display:inline-block;color:#000;"><?php echo date("d-m-Y", strtotime($requisitiondata->leave_from)); ?> to <?php echo date("d-m-Y", strtotime($requisitiondata->leave_to)); ?></strong>
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            <td colspan="3"  style="vertical-align:top;">
                ...
                <article  style="width:100%; min-height:50px;font-size:12px;border:3px solid #760000;box-sizing: border-box;padding:3px;">
        ...
        <tr>
            <td colspan="2" style="color:#760000;font-size:14px;font-weight:bold;">
                Approved By
            </td>
        </tr>
        <tr>
...
<div class="innerContent">
    ...
    <header class="pageTitleV3">
        ...
        <a class="btnAction print print_sec bgGreen" href="#">Print</a>
    </header>
