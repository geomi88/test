...
<script>
    ...
    var arrempids=<?php echo $arrEmployees?>;
    var arrSelectdPosition=<?php echo $arrSelectdPosition?>;
</script>
<div class="innerContent">
    <a class="btnBack" href="{{ URL::to('organizationchart/organizationchartnew/editlist')}}">Back</a>
    <header class="pageTitle">
        <h1>Update <span>Organization Chart</span></h1>
    </header>	

    <form action="" method="post" id="frmmain">
        <div class="fieldGroup" id="fieldSet1">
            <input type="hidden" value="{{$master_data->id}}" id="chartid">
            ...
            <div class="custRow">
                <div class="custCol-4">
                    <div class="inputHolder">
                        ...
                        <select  name="cmbcategory" id="cmbcategory" class="">
                            ...
                            <option value="{{$category->id}}" <?php if($category->id==$master_data->category){ echo "selected";}?>>{{$category->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="custCol-4">
                    <div class="inputHolder checklistcatName">
                        <label>Name</label>
                        <input type="text" name="name" id="name" value="{{$master_data->name}}" autocomplete="off" placeholder="Enter Name" maxlength="250">
                        <span class="commonError"></span>
                    </div>
                </div>
                ...
                <div class="custCol-4">
                    <div class="inputHolder">
                        <label>Alias</label>
                        <input type="text" class="arabicalign" name="alias_name" value="{{$master_data->alias_name}}" id="alias_name" placeholder="Enter Alias" maxlength="250">
                    </div>
                </div>
        ...
        <div class="custCol-4">
            <input type="button" value="Update" id="btnsavechart" class="commonBtn bgGreen addBtn" >
        </div>
    </div>
    </div>
        ...
        <form id="frmNodename">
            <div class="custCol-8">
                <div class="inputHolder">
                    ...
                    <input type="text" name="nodename" id="nodename"  autocomplete="off" placeholder="Enter Name" maxlength="250">
                    <span class="commonError"></span>
                </div>
            </div>
        </form>
    ...
    <div class="chartModal rootmodal" style="display: none;">
        ...
        <form id="frmRootNodename">
            <div class="custCol-8">
                <div class="inputHolder">
                    <label>Node Name</label>
                    <input type="text" name="rootnodename" id="rootnodename"  autocomplete="off" placeholder="Enter Name" maxlength="250">
                    <span class="commonError"></span>
                </div>
            </div>
        </form>
...
<script>
    ...
    if(arrempids.length==0){
        ...
        var objEmployees=arrempids;
    }
    
    var arrSelectedJobPositions = arrSelectdPosition;
...
//            }
        ...
        $('#btnsavechart').on('click', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '../updatechart',
                data: '&treeNodesJson=' + treeNodesJson + '&objEmployeesJson=' + objEmployeesJson + '&arrMaster=' + arraData + '&chartid=' + $("#chartid").val(),
                success: function (return_data) {
                    $('#btnsavechart').removeAttr('disabled');
                    $(".commonLoaderV1").hide();
                    window.location.href = '{{url("organizationchart/organizationchartnew/editlist")}}';
                },
