...
<div class="innerContent">
    <a class="btnBack" href="{{ URL::to('organizationchart/organizationchart/editlist')}}">Back</a>
    ...
    <form action="" method="post" id="frmmain">
        <div class="fieldGroup" id="fieldSet1">
            ...
            <input type="hidden" value="{{$master_data->based_on}}" id="based_on">
            <div class="custRow">
                <div class="custCol-4">
        ...
        $('#btnsavechart').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (return_data) {
                    ...
                    $(".commonLoaderV1").hide();
                    window.location.href = '{{url("organizationchart/organizationchart/editlist")}}';
                },
